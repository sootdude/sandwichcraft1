...
public class SafetyScreen extends WarningScreen {
   ...
   protected void initButtons(int p_210904_) {
      this.addRenderableWidget(Button.builder(CommonComponents.GUI_PROCEED, (p_210908_) -> {
      ...
      this.addRenderableWidget(Button.builder(CommonComponents.GUI_BACK, (p_210906_) -> {
