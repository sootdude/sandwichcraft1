   ...
   public boolean mouseClicked(double p_94125_, double p_94126_, int p_94127_) {
      if (this.isVisible() && p_94127_ == 0) {
         ...
         if (this.isFocused() && flag && p_94127_ == 0) {
            int i = Mth.floor(p_94125_) - this.getX();
            if (this.bordered) {
               i -= 4;
            }
   ...
   public void renderWidget(PoseStack p_94160_, int p_94161_, int p_94162_, float p_94163_) {
      if (this.isVisible()) {
         if (this.isBordered()) {
            ...
            fill(p_94160_, this.getX() - 1, this.getY() - 1, this.getX() + this.width + 1, this.getY() + this.height + 1, i);
            fill(p_94160_, this.getX(), this.getY(), this.getX() + this.width, this.getY() + this.height, -16777216);
         }
         ...
         if (this.hint != null && s.isEmpty() && !this.isFocused()) {
            this.font.drawShadow(p_94160_, this.hint, (float)j1, (float)i1, i2);
         }
         ...
         if (k != j) {
            ...
            this.renderHighlight(p_94160_, k1, i1 - 1, l1 - 1, i1 + 1 + 9);
         }

      }
   }

   private void renderHighlight(PoseStack p_265550_, int p_265338_, int p_265693_, int p_265618_, int p_265584_) {
      ...
      fill(p_265550_, p_265338_, p_265693_, p_265618_, p_265584_, -16776961);
