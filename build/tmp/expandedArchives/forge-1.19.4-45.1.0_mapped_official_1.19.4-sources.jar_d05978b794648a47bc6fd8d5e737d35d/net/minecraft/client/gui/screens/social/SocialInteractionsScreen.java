...
public class SocialInteractionsScreen extends Screen {
   ...
   protected void init() {
      ...
      this.blockingHintButton = this.addRenderableWidget(Button.builder(BLOCKING_HINT, (p_100770_) -> {
   ...
   public void renderBackground(PoseStack p_100761_) {
      ...
      blitNineSliced(p_100761_, i, 64, 236, this.windowHeight() + 16, 8, 236, 34, 1, 1);
      blit(p_100761_, i + 10, 76, 243, 1, 12, 12);
   }
   ...
   public void render(PoseStack p_100763_, int p_100764_, int p_100765_, float p_100766_) {
      ...
      if (!this.socialInteractionsPlayerList.isEmpty()) {
         ...
         drawCenteredString(p_100763_, this.minecraft.font, EMPTY_SEARCH, this.width / 2, (72 + this.listEnd()) / 2, -1);
      } else if (this.page == SocialInteractionsScreen.Page.HIDDEN) {
         drawCenteredString(p_100763_, this.minecraft.font, EMPTY_HIDDEN, this.width / 2, (72 + this.listEnd()) / 2, -1);
      } else if (this.page == SocialInteractionsScreen.Page.BLOCKED) {
         drawCenteredString(p_100763_, this.minecraft.font, EMPTY_BLOCKED, this.width / 2, (72 + this.listEnd()) / 2, -1);
      }
