...
public class HorseInventoryScreen extends AbstractContainerScreen<HorseInventoryMenu> {
   ...
   protected void renderBg(PoseStack p_98821_, float p_98822_, int p_98823_, int p_98824_) {
      ...
      blit(p_98821_, i, j, 0, 0, this.imageWidth, this.imageHeight);
      if (this.horse instanceof AbstractChestedHorse) {
         ...
         if (abstractchestedhorse.hasChest()) {
            blit(p_98821_, i + 79, j + 17, 0, this.imageHeight, abstractchestedhorse.getInventoryColumns() * 18, 54);
         }
      }

      if (this.horse.isSaddleable()) {
         blit(p_98821_, i + 7, j + 35 - 18, 18, this.imageHeight + 54, 18, 18);
      }

      if (this.horse.canWearArmor()) {
         if (this.horse instanceof Llama) {
            blit(p_98821_, i + 7, j + 35, 36, this.imageHeight + 54, 18, 18);
         } else {
            blit(p_98821_, i + 7, j + 35, 0, this.imageHeight + 54, 18, 18);
         }
      }

      InventoryScreen.renderEntityInInventoryFollowsMouse(p_98821_, i + 51, j + 60, 17, (float)(i + 51) - this.xMouse, (float)(j + 75 - 50) - this.yMouse, this.horse);
   }
