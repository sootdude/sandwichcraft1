...
public class AdvancementToast implements Toast {
   ...
   public Toast.Visibility render(PoseStack p_94800_, ToastComponent p_94801_, long p_94802_) {
      ...
      GuiComponent.blit(p_94800_, 0, 0, 0, 0, this.width(), this.height());
      if (displayinfo != null) {
         ...
         p_94801_.getMinecraft().getItemRenderer().renderAndDecorateFakeItem(p_94800_, displayinfo.getIcon(), 8, 8);
         return (double)p_94802_ >= 5000.0D * p_94801_.getNotificationDisplayTimeMultiplier() ? Toast.Visibility.HIDE : Toast.Visibility.SHOW;
      } else {
