...
public class TabNavigationBar extends AbstractContainerEventHandler implements Renderable, GuiEventListener, NarratableEntry {
   ...
   public void render(PoseStack p_275602_, int p_275474_, int p_275568_, float p_275702_) {
      fill(p_275602_, 0, 0, this.width, 24, -16777216);
      RenderSystem.setShaderTexture(0, CreateWorldScreen.HEADER_SEPERATOR);
      blit(p_275602_, 0, this.layout.getY() + this.layout.getHeight() - 2, 0.0F, 0.0F, this.width, 2, 32, 2);

      for(TabButton tabbutton : this.tabButtons) {
         tabbutton.render(p_275602_, p_275474_, p_275568_, p_275702_);
      }
