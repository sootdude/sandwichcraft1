...
public class TutorialToast implements Toast {
   ...
   public Toast.Visibility render(PoseStack p_94965_, ToastComponent p_94966_, long p_94967_) {
      ...
      GuiComponent.blit(p_94965_, 0, 0, 0, 96, this.width(), this.height());
      this.icon.render(p_94965_, 6, 6);
   ...
   public static enum Icons {
      ...
      public void render(PoseStack p_275665_, int p_275529_, int p_275455_) {
         RenderSystem.enableBlend();
         GuiComponent.blit(p_275665_, p_275529_, p_275455_, 176 + this.x * 20, this.y * 20, 20, 20);
      }
   }
}