...
public class MenuTooltipPositioner implements ClientTooltipPositioner {
   ...
   public Vector2ic positionTooltip(Screen p_268014_, int p_268356_, int p_268222_, int p_268194_, int p_268062_) {
      Vector2i vector2i = new Vector2i(p_268356_ + 12, p_268222_);
      if (vector2i.x + p_268194_ > p_268014_.width - 5) {
         vector2i.x = Math.max(p_268356_ - 12 - p_268194_, 9);
      }

      vector2i.y += 3;
      int i = p_268062_ + 3 + 3;
      int j = this.widget.getY() + this.widget.getHeight() + 3 + getOffset(0, 0, this.widget.getHeight());
      int k = p_268014_.height - 5;
      if (j + i <= k) {
