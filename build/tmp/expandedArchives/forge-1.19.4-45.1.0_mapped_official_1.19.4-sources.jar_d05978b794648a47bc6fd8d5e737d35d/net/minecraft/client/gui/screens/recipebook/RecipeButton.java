...
public class RecipeButton extends AbstractWidget {
   ...
   public void renderWidget(PoseStack p_100484_, int p_100485_, int p_100486_, float p_100487_) {
      ...
      if (flag) {
         ...
         p_100484_.pushPose();
         p_100484_.translate((float)(this.getX() + 8), (float)(this.getY() + 12), 0.0F);
         p_100484_.scale(f, f, 1.0F);
         p_100484_.translate((float)(-(this.getX() + 8)), (float)(-(this.getY() + 12)), 0.0F);
         this.animationTime -= p_100487_;
      }

      blit(p_100484_, this.getX(), this.getY(), i, j, this.width, this.height);
      ...
      if (this.collection.hasSingleResultItem() && this.getOrderedRecipes().size() > 1) {
         minecraft.getItemRenderer().renderAndDecorateItem(p_100484_, itemstack, this.getX() + k + 1, this.getY() + k + 1, 0, 10);
         --k;
      }

      minecraft.getItemRenderer().renderAndDecorateFakeItem(p_100484_, itemstack, this.getX() + k, this.getY() + k);
      if (flag) {
         p_100484_.popPose();
      }
