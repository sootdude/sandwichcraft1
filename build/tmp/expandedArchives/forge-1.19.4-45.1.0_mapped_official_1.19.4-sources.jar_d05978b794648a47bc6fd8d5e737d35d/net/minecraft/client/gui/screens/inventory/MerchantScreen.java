...
public class MerchantScreen extends AbstractContainerScreen<MerchantMenu> {
   ...
   private void renderAndDecorateCostA(PoseStack p_99163_, ItemStack p_99164_, ItemStack p_99165_, int p_99166_, int p_99167_) {
      ...
      if (p_99165_.getCount() == p_99164_.getCount()) {
         ...
         posestack.translate(0.0D, 0.0D, 200F);
         ...
         font.drawInBatch(String.valueOf(p_99164_.getCount()), (float) (p_99166_ + 14) + 19 - 2 - font.width(String.valueOf(p_99164_.getCount())), (float)p_99167_ + 6 + 3, 0xFFFFFF, true, posestack.last().pose(), bufferSource, net.minecraft.client.gui.Font.DisplayMode.NORMAL, 0, 15728880, false);
