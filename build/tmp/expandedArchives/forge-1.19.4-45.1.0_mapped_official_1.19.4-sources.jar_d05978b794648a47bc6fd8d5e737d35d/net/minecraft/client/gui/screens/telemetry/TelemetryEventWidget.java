...
public class TelemetryEventWidget extends AbstractScrollWidget {
   ...
   protected void renderContents(PoseStack p_261905_, int p_262043_, int p_261724_, float p_262063_) {
      int i = this.getY() + this.innerPadding();
      int j = this.getX() + this.innerPadding();
      p_261905_.pushPose();
      p_261905_.translate((double)j, (double)i, 0.0D);
      this.content.container().visitWidgets((p_265533_) -> {
         p_265533_.render(p_261905_, p_262043_, p_261724_, p_262063_);
      });
      p_261905_.popPose();
   }
