...
public class DisconnectedScreen extends Screen {
   ...
   protected void init() {
      ...
      this.addRenderableWidget(Button.builder(Component.translatable("gui.toMenu"), (p_96002_) -> {
         this.minecraft.setScreen(this.parent);
      }).bounds(this.width / 2 - 100, Math.min(this.height / 2 + this.textHeight / 2 + 9, this.height - 30), 200, 20).build());
   }
