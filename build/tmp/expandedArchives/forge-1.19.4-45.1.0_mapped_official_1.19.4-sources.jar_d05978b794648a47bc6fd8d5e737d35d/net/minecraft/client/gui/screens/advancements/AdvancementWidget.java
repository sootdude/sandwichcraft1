...
public class AdvancementWidget extends GuiComponent {
   ...
   public void drawConnectivity(PoseStack p_97299_, int p_97300_, int p_97301_, boolean p_97302_) {
      if (this.parent != null) {
         ...
         if (p_97302_) {
            hLine(p_97299_, j, i, k - 1, j1);
            hLine(p_97299_, j + 1, i, k, j1);
            hLine(p_97299_, j, i, k + 1, j1);
            hLine(p_97299_, l, j - 1, i1 - 1, j1);
            hLine(p_97299_, l, j - 1, i1, j1);
            hLine(p_97299_, l, j - 1, i1 + 1, j1);
            vLine(p_97299_, j - 1, i1, k, j1);
            vLine(p_97299_, j + 1, i1, k, j1);
         } else {
            hLine(p_97299_, j, i, k, j1);
            hLine(p_97299_, l, j, i1, j1);
            vLine(p_97299_, j, i1, k, j1);
         }
      }
   ...
   public void draw(PoseStack p_97267_, int p_97268_, int p_97269_) {
      if (!this.display.isHidden() || this.progress != null && this.progress.isDone()) {
         ...
         blit(p_97267_, p_97268_ + this.x + 3, p_97269_ + this.y, this.display.getFrame().getTexture(), 128 + advancementwidgettype.getIndex() * 26, 26, 26);
         this.minecraft.getItemRenderer().renderAndDecorateFakeItem(p_97267_, this.display.getIcon(), p_97268_ + this.x + 8, p_97269_ + this.y + 5);
      }
   ...
   public void drawHover(PoseStack p_97271_, int p_97272_, int p_97273_, float p_97274_, int p_97275_, int p_97276_) {
      ...
      if (!this.description.isEmpty()) {
         if (flag1) {
            blitNineSliced(p_97271_, i1, l + 26 - j1, this.width, j1, 10, 200, 26, 0, 52);
         } else {
            blitNineSliced(p_97271_, i1, l, this.width, j1, 10, 200, 26, 0, 52);
         }
      }

      blit(p_97271_, i1, l, 0, advancementwidgettype.getIndex() * 26, j, 26);
      blit(p_97271_, i1 + j, l, 200 - k, advancementwidgettype1.getIndex() * 26, k, 26);
      blit(p_97271_, p_97272_ + this.x + 3, p_97273_ + this.y, this.display.getFrame().getTexture(), 128 + advancementwidgettype2.getIndex() * 26, 26, 26);
      if (flag) {
      ...
      this.minecraft.getItemRenderer().renderAndDecorateFakeItem(p_97271_, this.display.getIcon(), p_97272_ + this.x + 8, p_97273_ + this.y + 5);
   }
