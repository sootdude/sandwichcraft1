...
public class BookEditScreen extends Screen {
   ...
   private final TextFieldHelper pageEdit = new TextFieldHelper(this::getCurrentPageText, this::setCurrentPageText, this::getClipboard, this::setClipboard, (p_274678_) -> {
      return p_274678_.length() < 1024 && this.font.wordWrapHeight(p_274678_, 114) <= 128;
   });
   ...
   protected void init() {
      ...
      this.doneButton = this.addRenderableWidget(Button.builder(CommonComponents.GUI_DONE, (p_98173_) -> {
         this.minecraft.setScreen((Screen)null);
         this.saveChanges(false);
      }).bounds(this.width / 2 + 2, 196, 98, 20).build());
      this.finalizeButton = this.addRenderableWidget(Button.builder(Component.translatable("book.finalizeButton"), (p_98168_) -> {
         if (this.isSigning) {
   ...
   public void render(PoseStack p_98104_, int p_98105_, int p_98106_, float p_98107_) {
      ...
      if (this.isSigning) {
         ...
         this.font.drawWordWrap(p_98104_, FINALIZE_WARNING_LABEL, i + 36, 82, 114, 0);
      } else {
         ...
         this.renderHighlight(p_98104_, bookeditscreen$displaycache.selection);
   ...
   private void renderHighlight(PoseStack p_265214_, Rect2i[] p_265482_) {
      ...
      for(Rect2i rect2i : p_265482_) {
         ...
         fill(p_265214_, i, j, k, l, -16776961);
      }
