...
public class TabButton extends AbstractWidget {
   ...
   public void renderWidget(PoseStack p_275359_, int p_275220_, int p_275351_, float p_275440_) {
      RenderSystem.setShaderTexture(0, TEXTURE_LOCATION);
      blitNineSliced(p_275359_, this.getX(), this.getY(), this.width, this.height, 2, 2, 2, 0, 130, 24, 0, this.getTextureY());
      Font font = Minecraft.getInstance().font;
      int i = this.active ? -1 : -6250336;
      this.renderString(p_275359_, font, i);
      if (this.isSelected()) {
         this.renderFocusUnderline(p_275359_, font, i);
      }
