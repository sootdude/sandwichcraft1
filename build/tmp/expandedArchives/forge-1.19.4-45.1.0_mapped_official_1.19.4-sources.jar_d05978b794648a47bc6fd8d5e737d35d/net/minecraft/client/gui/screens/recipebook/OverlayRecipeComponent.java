...
public class OverlayRecipeComponent extends GuiComponent implements Renderable, GuiEventListener {
   ...
   public void render(PoseStack p_100190_, int p_100191_, int p_100192_, float p_100193_) {
      if (this.isVisible) {
         ...
         p_100190_.pushPose();
         p_100190_.translate(0.0F, 0.0F, 170.0F);
         ...
         int l = 4;
         blitNineSliced(p_100190_, this.x, this.y, j * 25 + 8, k * 25 + 8, 4, 32, 32, 82, 208);
   ...
   class OverlayRecipeButton extends AbstractWidget implements PlaceRecipe<Ingredient> {
      ...
      public void renderWidget(PoseStack p_100246_, int p_100247_, int p_100248_, float p_100249_) {
         ...
         blit(p_100246_, this.getX(), this.getY(), i, j, this.width, this.height);
         p_100246_.pushPose();
         p_100246_.translate((double)(this.getX() + 2), (double)(this.getY() + 2), 150.0D);

         for(OverlayRecipeComponent.OverlayRecipeButton.Pos overlayrecipecomponent$overlayrecipebutton$pos : this.ingredientPos) {
            p_100246_.pushPose();
            p_100246_.translate((double)overlayrecipecomponent$overlayrecipebutton$pos.x, (double)overlayrecipecomponent$overlayrecipebutton$pos.y, 0.0D);
            p_100246_.scale(0.375F, 0.375F, 1.0F);
            p_100246_.translate(-8.0D, -8.0D, 0.0D);
            OverlayRecipeComponent.this.minecraft.getItemRenderer().renderAndDecorateItem(p_100246_, overlayrecipecomponent$overlayrecipebutton$pos.ingredients[Mth.floor(OverlayRecipeComponent.this.time / 30.0F) % overlayrecipecomponent$overlayrecipebutton$pos.ingredients.length], 0, 0);
            p_100246_.popPose();
         }
