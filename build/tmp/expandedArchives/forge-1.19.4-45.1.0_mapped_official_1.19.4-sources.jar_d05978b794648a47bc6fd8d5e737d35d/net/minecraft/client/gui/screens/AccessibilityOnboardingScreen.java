...
public class AccessibilityOnboardingScreen extends Screen {
   ...
   public void init() {
      ...
      gridlayout$rowhelper.addChild(CommonButtons.accessibilityTextAndImage((p_272309_) -> {
         this.closeAndSetScreen(new AccessibilityOptionsScreen(this, this.minecraft.options));
      }));
      gridlayout$rowhelper.addChild(CommonButtons.languageTextAndImage((p_272308_) -> {
   ...
   public void render(PoseStack p_265431_, int p_265135_, int p_265032_, float p_265387_) {
      this.handleInitialNarrationDelay();
      this.panorama.render(0.0F, 1.0F);
      fill(p_265431_, 0, 0, this.width, this.height, -1877995504);
      this.logoRenderer.renderLogo(p_265431_, this.width, 1.0F);
      if (this.textWidget != null) {
         this.textWidget.render(p_265431_, p_265135_, p_265032_, p_265387_);
      }

      super.render(p_265431_, p_265135_, p_265032_, p_265387_);
   }
