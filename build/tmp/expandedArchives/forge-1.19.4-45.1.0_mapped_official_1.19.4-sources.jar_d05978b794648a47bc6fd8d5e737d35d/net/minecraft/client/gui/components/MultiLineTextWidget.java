...
public class MultiLineTextWidget extends AbstractStringWidget {
   ...
   public void renderWidget(PoseStack p_261473_, int p_261774_, int p_261640_, float p_261514_) {
      ...
      int l = this.getColor();
      if (this.centered) {
         multilinelabel.renderCentered(p_261473_, i + this.getWidth() / 2, j, k, l);
      } else {
         multilinelabel.renderLeftAligned(p_261473_, i, j, k, l);
      }
