...
public class AccessibilityOptionsScreen extends SimpleOptionsSubScreen {
   ...
   protected void createFooter() {
      this.addRenderableWidget(Button.builder(Component.translatable("options.accessibility.link"), (p_95509_) -> {
      ...
      this.addRenderableWidget(Button.builder(CommonComponents.GUI_DONE, (p_95507_) -> {
