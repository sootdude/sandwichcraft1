...
public class StructureBlockEditScreen extends Screen {
   ...
   protected void init() {
      ...
      this.saveButton = this.addRenderableWidget(Button.builder(Component.translatable("structure_block.button.save"), (p_99454_) -> {
      ...
      this.loadButton = this.addRenderableWidget(Button.builder(Component.translatable("structure_block.button.load"), (p_99451_) -> {
      ...
      this.detectButton = this.addRenderableWidget(Button.builder(Component.translatable("structure_block.button.detect_size"), (p_99443_) -> {
         if (this.structure.getMode() == StructureMode.SAVE) {
