...
public class AnvilScreen extends ItemCombinerScreen<AnvilMenu> {
   ...
   protected void renderBg(PoseStack p_266709_, float p_267227_, int p_266905_, int p_267042_) {
      super.renderBg(p_266709_, p_267227_, p_266905_, p_267042_);
      blit(p_266709_, this.leftPos + 59, this.topPos + 20, 0, this.imageHeight + (this.menu.getSlot(0).hasItem() ? 0 : 16), 110, 16);
   }
   ...
   protected void renderErrorIcon(PoseStack p_267066_, int p_266703_, int p_266956_) {
      if ((this.menu.getSlot(0).hasItem() || this.menu.getSlot(1).hasItem()) && !this.menu.getSlot(this.menu.getResultSlot()).hasItem()) {
         blit(p_267066_, p_266703_ + 99, p_266956_ + 45, this.imageWidth, 0, 28, 21);
      }
