...
public class MultiLineEditBox extends AbstractScrollWidget {
   ...
   protected void renderContents(PoseStack p_239001_, int p_239002_, int p_239003_, float p_239004_) {
      ...
      if (s.isEmpty() && !this.isFocused()) {
         this.font.drawWordWrap(p_239001_, this.placeholder, this.getX() + this.innerPadding(), this.getY() + this.innerPadding(), this.width - this.totalInnerPadding(), -857677600);
      } else {
         ...
         for(MultilineTextField.StringView multilinetextfield$stringview : this.textField.iterateLines()) {
            ...
            if (flag && flag1 && i >= multilinetextfield$stringview.beginIndex() && i <= multilinetextfield$stringview.endIndex()) {
               if (flag2) {
                  j = this.font.drawShadow(p_239001_, s.substring(multilinetextfield$stringview.beginIndex(), i), (float)(this.getX() + this.innerPadding()), (float)l, -2039584) - 1;
               ...
               if (flag2) {
                  j = this.font.drawShadow(p_239001_, s.substring(multilinetextfield$stringview.beginIndex(), multilinetextfield$stringview.endIndex()), (float)(this.getX() + this.innerPadding()), (float)l, -2039584) - 1;
               }
   ...
   protected void renderDecorations(PoseStack p_239517_) {
      ...
      if (this.textField.hasCharacterLimit()) {
         ...
         drawString(p_239517_, this.font, component, this.getX() + this.width - this.font.width(component), this.getY() + this.height + 4, 10526880);
      }
   ...
   private void renderHighlight(PoseStack p_239487_, int p_239488_, int p_239489_, int p_239490_, int p_239491_) {
      ...
      fill(p_239487_, p_239488_, p_239489_, p_239490_, p_239491_, -16776961);
