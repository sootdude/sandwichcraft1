...
public class CreateBuffetWorldScreen extends Screen {
   ...
   protected void init() {
      ...
      this.doneButton = this.addRenderableWidget(Button.builder(CommonComponents.GUI_DONE, (p_95761_) -> {
         this.applySettings.accept(this.biome);
         this.minecraft.setScreen(this.parent);
      }).bounds(this.width / 2 - 155, this.height - 28, 150, 20).build());
      this.addRenderableWidget(Button.builder(CommonComponents.GUI_CANCEL, (p_232736_) -> {
         this.minecraft.setScreen(this.parent);
   ...
   public void render(PoseStack p_95756_, int p_95757_, int p_95758_, float p_95759_) {
      this.renderDirtBackground(p_95756_);
