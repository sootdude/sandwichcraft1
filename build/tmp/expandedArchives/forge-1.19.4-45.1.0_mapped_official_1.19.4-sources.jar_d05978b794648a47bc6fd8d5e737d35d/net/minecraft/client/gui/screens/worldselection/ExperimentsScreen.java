...
public class ExperimentsScreen extends Screen {
   ...
   public void render(PoseStack p_270348_, int p_270488_, int p_270269_, float p_270418_) {
      this.renderBackground(p_270348_);
      RenderSystem.setShaderTexture(0, GuiComponent.BACKGROUND_LOCATION);
      RenderSystem.setShaderColor(0.125F, 0.125F, 0.125F, 1.0F);
      int i = 32;
      blit(p_270348_, 0, this.layout.getHeaderHeight(), 0.0F, 0.0F, this.width, this.height - this.layout.getHeaderHeight() - this.layout.getFooterHeight(), 32, 32);
      RenderSystem.setShaderColor(1.0F, 1.0F, 1.0F, 1.0F);
      super.render(p_270348_, p_270488_, p_270269_, p_270418_);
   }
}