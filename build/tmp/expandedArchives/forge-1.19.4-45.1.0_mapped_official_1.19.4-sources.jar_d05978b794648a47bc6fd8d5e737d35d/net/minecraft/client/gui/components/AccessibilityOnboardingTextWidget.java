...
public class AccessibilityOnboardingTextWidget extends MultiLineTextWidget {
   ...
   public void renderWidget(PoseStack p_268175_, int p_267981_, int p_268038_, float p_268050_) {
      int i = this.getX() - 3;
      int j = this.getY() - 3;
      int k = this.getX() + this.getWidth() + 3;
      int l = this.getY() + this.getHeight() + 3;
      int i1 = this.isFocused() ? -1 : -6250336;
      fill(p_268175_, i - 1, j - 1, i, l + 1, i1);
      fill(p_268175_, k, j - 1, k + 1, l + 1, i1);
      fill(p_268175_, i, j, k, j - 1, i1);
      fill(p_268175_, i, l, k, l + 1, i1);
      fill(p_268175_, i, j, k, l, 1426063360);
      super.renderWidget(p_268175_, p_267981_, p_268038_, p_268050_);
   }
