...
public class ChatReportScreen extends Screen {
   ...
   protected void init() {
      ...
      this.addRenderableWidget(Button.builder(component, (p_239836_) -> {
      ...
      this.addRenderableWidget(Button.builder(component1, (p_239172_) -> {
   ...
   private void sendReport() {
      this.reportBuilder.build(this.reportingContext).ifLeft((p_240239_) -> {
   ...
   class DiscardReportWarningScreen extends WarningScreen {
      ...
      protected void initButtons(int p_239753_) {
         ...
         this.addRenderableWidget(Button.builder(DRAFT, (p_239170_) -> {
         ...
         this.addRenderableWidget(Button.builder(DISCARD, (p_253321_) -> {
