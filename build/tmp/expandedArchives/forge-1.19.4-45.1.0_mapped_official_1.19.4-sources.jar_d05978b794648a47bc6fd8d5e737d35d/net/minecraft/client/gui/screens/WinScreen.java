...
public class WinScreen extends Screen {
   ...
   private void renderBg(PoseStack p_265462_) {
      ...
      blit(p_265462_, 0, 0, 0, 0.0F, f, i, this.height, 64, 64);
   ...
   public void render(PoseStack p_96884_, int p_96885_, int p_96886_, float p_96887_) {
      ...
      this.renderBg(p_96884_);
      int i = this.width / 2 - 137;
      int j = this.height + 50;
      float f = -this.scroll;
      p_96884_.pushPose();
      p_96884_.translate(0.0F, f, 0.0F);
      this.logoRenderer.renderLogo(p_96884_, this.width, 1.0F, j);
      int k = j + 100;
      ...
      for(int l = 0; l < this.lines.size(); ++l) {
         if (l == this.lines.size() - 1) {
            ...
            if (f1 < 0.0F) {
               p_96884_.translate(0.0F, -f1, 0.0F);
            }
         }
      ...
      blit(p_96884_, 0, 0, 0, 0.0F, 0.0F, this.width, this.height, this.width, this.height);
