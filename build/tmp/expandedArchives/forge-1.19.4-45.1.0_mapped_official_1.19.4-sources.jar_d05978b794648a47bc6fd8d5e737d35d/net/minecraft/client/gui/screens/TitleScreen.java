...
public class TitleScreen extends Screen {
   ...
   public void render(PoseStack p_96739_, int p_96740_, int p_96741_, float p_96742_) {
      ...
      if ((i & -67108864) != 0) {
         ...
         net.minecraftforge.client.ForgeHooksClient.renderMainMenu(this, p_96739_, this.font, this.width, this.height, i);
         if (this.splash != null) {
            p_96739_.pushPose();
         ...
         net.minecraftforge.internal.BrandingControl.forEachLine(true, true, (brdline, brd) ->
            drawString(p_96739_, this.font, brd, 2, this.height - ( 10 + brdline * (this.font.lineHeight + 1)), 16777215 | i)
         );

         net.minecraftforge.internal.BrandingControl.forEachAboveCopyrightLine((brdline, brd) ->
            drawString(p_96739_, this.font, brd, this.width - font.width(brd), this.height - (10 + (brdline + 1) * ( this.font.lineHeight + 1)), 16777215 | i)
         );
