...
public class GameModeSwitcherScreen extends Screen {
   ...
   public void render(PoseStack p_97557_, int p_97558_, int p_97559_, float p_97560_) {
      if (!this.checkToClose()) {
         ...
         this.currentlyHovered.ifPresent((p_274676_) -> {
            drawCenteredString(p_97557_, this.font, p_274676_.getName(), this.width / 2, this.height / 2 - 31 - 20, -1);
         });
   ...
   private static void switchToHoveredGameMode(Minecraft p_97565_, Optional<GameModeSwitcherScreen.GameModeIcon> p_97566_) {
      if (p_97565_.gameMode != null && p_97565_.player != null && p_97566_.isPresent()) {
         ...
         if (optional.isPresent() && p_97565_.player.hasPermissions(2) && gamemodeswitcherscreen$gamemodeicon != optional.get()) {
            p_97565_.player.connection.sendUnsignedCommand(gamemodeswitcherscreen$gamemodeicon.getCommand());
         }
   ...
   static enum GameModeIcon {
      ...
      void drawIcon(PoseStack p_275466_, ItemRenderer p_275720_, int p_275491_, int p_275256_) {
         p_275720_.renderAndDecorateItem(p_275466_, this.renderStack, p_275491_, p_275256_);
      }
   ...
   public class GameModeSlot extends AbstractWidget {
      ...
      public void renderWidget(PoseStack p_97636_, int p_97637_, int p_97638_, float p_97639_) {
         Minecraft minecraft = Minecraft.getInstance();
         this.drawSlot(p_97636_, minecraft.getTextureManager());
         this.icon.drawIcon(p_97636_, GameModeSwitcherScreen.this.itemRenderer, this.getX() + 5, this.getY() + 5);
         if (this.isSelected) {
      ...
      private void drawSlot(PoseStack p_97631_, TextureManager p_97632_) {
         ...
         p_97631_.pushPose();
         p_97631_.translate((float)this.getX(), (float)this.getY(), 0.0F);
      ...
      private void drawSelection(PoseStack p_97641_, TextureManager p_97642_) {
         RenderSystem.setShaderTexture(0, GameModeSwitcherScreen.GAMEMODE_SWITCHER_LOCATION);
         p_97641_.pushPose();
         p_97641_.translate((float)this.getX(), (float)this.getY(), 0.0F);
