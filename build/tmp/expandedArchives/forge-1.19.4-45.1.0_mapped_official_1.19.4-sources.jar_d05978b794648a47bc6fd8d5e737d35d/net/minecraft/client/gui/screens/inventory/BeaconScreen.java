...
public class BeaconScreen extends AbstractContainerScreen<BeaconMenu> {
   ...
   protected void renderBg(PoseStack p_97916_, float p_97917_, int p_97918_, int p_97919_) {
      ...
      blit(p_97916_, i, j, 0, 0, this.imageWidth, this.imageHeight);
      p_97916_.pushPose();
      p_97916_.translate(0.0F, 0.0F, 100.0F);
      this.itemRenderer.renderAndDecorateItem(p_97916_, new ItemStack(Items.NETHERITE_INGOT), i + 20, j + 109);
      this.itemRenderer.renderAndDecorateItem(p_97916_, new ItemStack(Items.EMERALD), i + 41, j + 109);
      this.itemRenderer.renderAndDecorateItem(p_97916_, new ItemStack(Items.DIAMOND), i + 41 + 22, j + 109);
      this.itemRenderer.renderAndDecorateItem(p_97916_, new ItemStack(Items.GOLD_INGOT), i + 42 + 44, j + 109);
      this.itemRenderer.renderAndDecorateItem(p_97916_, new ItemStack(Items.IRON_INGOT), i + 42 + 66, j + 109);
      p_97916_.popPose();
   }
   ...
   class BeaconPowerButton extends BeaconScreen.BeaconScreenButton {
      ...
      protected void renderIcon(PoseStack p_98014_) {
         ...
         blit(p_98014_, this.getX() + 2, this.getY() + 2, 0, 18, 18, this.sprite);
      }
   ...
   abstract static class BeaconScreenButton extends AbstractButton implements BeaconScreen.BeaconButton {
      ...
      public void renderWidget(PoseStack p_98027_, int p_98028_, int p_98029_, float p_98030_) {
         ...
         blit(p_98027_, this.getX(), this.getY(), j, 219, this.width, this.height);
   ...
   abstract static class BeaconSpriteScreenButton extends BeaconScreen.BeaconScreenButton {
      ...
      protected void renderIcon(PoseStack p_98041_) {
         blit(p_98041_, this.getX() + 2, this.getY() + 2, this.iconX, this.iconY, 18, 18);
      }
   }
