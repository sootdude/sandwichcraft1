...
public class DecoratedPotRenderer implements BlockEntityRenderer<DecoratedPotBlockEntity> {
   ...
   public void render(DecoratedPotBlockEntity p_273776_, float p_273103_, PoseStack p_273455_, MultiBufferSource p_273010_, int p_273407_, int p_273059_) {
      ...
      List<Item> list = p_273776_.getShards();
      this.renderSide(this.frontSide, p_273455_, p_273010_, p_273407_, p_273059_, getMaterial(list.get(3)));
      this.renderSide(this.backSide, p_273455_, p_273010_, p_273407_, p_273059_, getMaterial(list.get(0)));
      this.renderSide(this.leftSide, p_273455_, p_273010_, p_273407_, p_273059_, getMaterial(list.get(1)));
      this.renderSide(this.rightSide, p_273455_, p_273010_, p_273407_, p_273059_, getMaterial(list.get(2)));
      p_273455_.popPose();
   }
