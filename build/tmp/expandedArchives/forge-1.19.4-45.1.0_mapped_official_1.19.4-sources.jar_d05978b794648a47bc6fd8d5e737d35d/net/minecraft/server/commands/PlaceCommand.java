...
public class PlaceCommand {
   ...
   public static int placeStructure(CommandSourceStack p_214588_, Holder.Reference<Structure> p_251799_, BlockPos p_214590_) throws CommandSyntaxException {
      ...
      if (!structurestart.isValid()) {
         ...
         ChunkPos.rangeClosed(chunkpos, chunkpos1).forEach((p_269763_) -> {
            structurestart.placeInChunk(serverlevel, serverlevel.structureManager(), chunkgenerator, serverlevel.getRandom(), new BoundingBox(p_269763_.getMinBlockX(), serverlevel.getMinBuildHeight(), p_269763_.getMinBlockZ(), p_269763_.getMaxBlockX(), serverlevel.getMaxBuildHeight(), p_269763_.getMaxBlockZ()), p_269763_);
         });
