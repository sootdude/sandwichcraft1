...
public class SpawnArmorTrimsCommand {
   ...
   public static void register(CommandDispatcher<CommandSourceStack> p_266758_) {
      p_266758_.register(Commands.literal("spawn_armor_trims").requires((p_267144_) -> {
         return p_267144_.hasPermission(2) && p_267144_.getLevel().enabledFeatures().contains(FeatureFlags.UPDATE_1_20);
      }).executes((p_267005_) -> {
   ...
   private static int spawnArmorTrims(CommandSourceStack p_266993_, Player p_266983_) {
      Level level = p_266983_.getLevel();
