...
public class ExperienceCommand {
   ...
   static enum Type {
      POINTS("points", Player::giveExperiencePoints, (p_275896_, p_275897_) -> {
         if (p_275897_ >= p_275896_.getXpNeededForNextLevel()) {
            return false;
         } else {
            p_275896_.setExperiencePoints(p_275897_);
            return true;
         }
      }, (p_275898_) -> {
         return Mth.floor(p_275898_.experienceProgress * (float)p_275898_.getXpNeededForNextLevel());
      }),
      LEVELS("levels", ServerPlayer::giveExperienceLevels, (p_137360_, p_137361_) -> {
         p_137360_.setExperienceLevels(p_137361_);
         return true;
      }, (p_274816_) -> {
         return p_274816_.experienceLevel;
      });
