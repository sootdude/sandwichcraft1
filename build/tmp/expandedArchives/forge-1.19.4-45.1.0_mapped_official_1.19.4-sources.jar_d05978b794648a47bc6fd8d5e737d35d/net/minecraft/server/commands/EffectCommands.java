...
public class EffectCommands {
   ...
   private static int giveEffect(CommandSourceStack p_250553_, Collection<? extends Entity> p_250411_, Holder<MobEffect> p_249495_, @Nullable Integer p_249652_, int p_251498_, boolean p_249944_) throws CommandSyntaxException {
      ...
      if (i == 0) {
         ...
         if (p_250411_.size() == 1) {
            p_250553_.sendSuccess(Component.translatable("commands.effect.give.success.single", mobeffect.getDisplayName(), p_250411_.iterator().next().getDisplayName(), j / 20), true);
         } else {
   ...
   private static int clearEffect(CommandSourceStack p_250069_, Collection<? extends Entity> p_248561_, Holder<MobEffect> p_249198_) throws CommandSyntaxException {
      ...
      if (i == 0) {
         ...
         if (p_248561_.size() == 1) {
            p_250069_.sendSuccess(Component.translatable("commands.effect.clear.specific.success.single", mobeffect.getDisplayName(), p_248561_.iterator().next().getDisplayName()), true);
         } else {
