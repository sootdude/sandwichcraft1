...
public class WorldBorderCommand {
   ...
   public static void register(CommandDispatcher<CommandSourceStack> p_139247_) {
      ...
      }).then(Commands.literal("add").then(Commands.argument("distance", DoubleArgumentType.doubleArg((double)-5.999997E7F, (double)5.999997E7F)).executes((p_269766_) -> {
         return setSize(p_269766_.getSource(), p_269766_.getSource().getLevel().getWorldBorder().getSize() + DoubleArgumentType.getDouble(p_269766_, "distance"), 0L);
      }).then(Commands.argument("time", IntegerArgumentType.integer(0)).executes((p_269767_) -> {
         return setSize(p_269767_.getSource(), p_269767_.getSource().getLevel().getWorldBorder().getSize() + DoubleArgumentType.getDouble(p_269767_, "distance"), p_269767_.getSource().getLevel().getWorldBorder().getLerpRemainingTime() + (long)IntegerArgumentType.getInteger(p_269767_, "time") * 1000L);
