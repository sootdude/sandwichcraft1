   ...
   private static int enchant(CommandSourceStack p_249815_, Collection<? extends Entity> p_248848_, Holder<Enchantment> p_251252_, int p_249941_) throws CommandSyntaxException {
      ...
      if (p_249941_ > enchantment.getMaxLevel()) {
         ...
         if (i == 0) {
            ...
            if (p_248848_.size() == 1) {
               p_249815_.sendSuccess(Component.translatable("commands.enchant.success.single", enchantment.getFullname(p_249941_), p_248848_.iterator().next().getDisplayName()), true);
            } else {
               p_249815_.sendSuccess(Component.translatable("commands.enchant.success.multiple", enchantment.getFullname(p_249941_), p_248848_.size()), true);
            }
