...
public class TimeCommand {
   public static void register(CommandDispatcher<CommandSourceStack> p_139072_) {
      ...
      })).then(Commands.literal("gametime").executes((p_269764_) -> {
         return queryTime(p_269764_.getSource(), (int)(p_269764_.getSource().getLevel().getGameTime() % 2147483647L));
      })).then(Commands.literal("day").executes((p_269765_) -> {
         return queryTime(p_269765_.getSource(), (int)(p_269765_.getSource().getLevel().getDayTime() / 24000L % 2147483647L));
      }))));
   }
