...
public class WhitelistCommand {
   ...
   public static void register(CommandDispatcher<CommandSourceStack> p_139202_) {
      p_139202_.register(Commands.literal("whitelist").requires((p_139234_) -> {
         ...
         return SharedSuggestionProvider.suggest(playerlist.getPlayers().stream().filter((p_275905_) -> {
            return !playerlist.getWhiteList().isWhiteListed(p_275905_.getGameProfile());
         }).map((p_275903_) -> {
            return p_275903_.getGameProfile().getName();
         }), p_139217_);
      }).executes((p_139224_) -> {
