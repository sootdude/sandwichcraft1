...
public class DamageCommand {
   ...
   public static void register(CommandDispatcher<CommandSourceStack> p_270226_, CommandBuildContext p_270136_) {
      ...
      }).then(Commands.argument("target", EntityArgument.entity()).then(Commands.argument("amount", FloatArgumentType.floatArg(0.0F)).executes((p_270449_) -> {
         return damage(p_270449_.getSource(), EntityArgument.getEntity(p_270449_, "target"), FloatArgumentType.getFloat(p_270449_, "amount"), p_270449_.getSource().getLevel().damageSources().generic());
