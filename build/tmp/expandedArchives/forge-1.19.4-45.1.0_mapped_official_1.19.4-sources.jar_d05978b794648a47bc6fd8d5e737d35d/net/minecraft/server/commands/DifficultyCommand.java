...
public class DifficultyCommand {
   ...
   public static void register(CommandDispatcher<CommandSourceStack> p_136939_) {
      ...
      p_136939_.register(literalargumentbuilder.requires((p_136943_) -> {
         ...
         Difficulty difficulty1 = p_248122_.getSource().getLevel().getDifficulty();
         p_248122_.getSource().sendSuccess(Component.translatable("commands.difficulty.query", difficulty1.getDisplayName()), false);
