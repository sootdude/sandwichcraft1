...
public class MultiNoiseBiomeSourceParameterLists {
   ...
   public static void nextUpdate(BootstapContext<MultiNoiseBiomeSourceParameterList> p_275487_) {
      HolderGetter<Biome> holdergetter = p_275487_.lookup(Registries.BIOME);
      p_275487_.register(OVERWORLD, new MultiNoiseBiomeSourceParameterList(MultiNoiseBiomeSourceParameterList.Preset.OVERWORLD_UPDATE_1_20, holdergetter));
   }
