...
public final class OverworldBiomeBuilder {
   ...
   public OverworldBiomeBuilder(OverworldBiomeBuilder.Modifier p_273306_) {
      this.modifier = p_273306_;
   }
   ...
   private ResourceKey<Biome> pickPlateauBiome(int p_187234_, int p_187235_, Climate.Parameter p_187236_) {
      ...
      return p_187236_.max() >= 0L && resourcekey != null && (resourcekey != Biomes.CHERRY_GROVE || this.modifier == OverworldBiomeBuilder.Modifier.UPDATE_1_20) ? resourcekey : this.PLATEAU_BIOMES[p_187234_][p_187235_];
   }
