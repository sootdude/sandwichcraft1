...
public class DesertPyramidPiece extends ScatteredFeaturePiece {
   ...
   public void postProcess(WorldGenLevel p_227405_, StructureManager p_227406_, ChunkGenerator p_227407_, RandomSource p_227408_, BoundingBox p_227409_, ChunkPos p_227410_, BlockPos p_227411_) {
      if (this.updateHeightPositionToLowestGroundHeight(p_227405_, -p_227408_.nextInt(3))) {
         ...
         if (p_227405_.enabledFeatures().contains(FeatureFlags.UPDATE_1_20)) {
   ...
   private void addCellarStairs(BlockPos p_272997_, WorldGenLevel p_272699_, BoundingBox p_273559_) {
      ...
      this.placeBlock(p_272699_, blockstate.rotate(Rotation.COUNTERCLOCKWISE_90), 12, 0, 17, p_273559_);
      ...
      this.placeBlock(p_272699_, blockstate1, i - 1, j + 3, k + 4, p_273559_);
      this.placeBlock(p_272699_, blockstate1, i, j + 3, k + 4, p_273559_);
      this.placeBlock(p_272699_, blockstate1, i - 1, j + 2, k + 4, p_273559_);
      this.placeBlock(p_272699_, flag ? blockstate1 : blockstate2, i, j + 2, k + 4, p_273559_);
      this.placeBlock(p_272699_, flag ? blockstate1 : blockstate2, i, j + 1, k + 4, p_273559_);
   }
   ...
   private void addCellarRoom(BlockPos p_272733_, WorldGenLevel p_273390_, BoundingBox p_273517_) {
      ...
      this.placeSandBox(p_273517_, i - 2, j + 1, k - 2, i + 2, j + 3, k + 2);
      ...
      this.placeSand(i + 3, j + 1, k, p_273517_);
      this.placeSand(i + 3, j + 2, k, p_273517_);
      ...
      this.placeSand(i, j + 1, k + 3, p_273517_);
      this.placeSand(i, j + 2, k + 3, p_273517_);
      this.placeBlock(p_273390_, blockstate2, i, j, k - 3, p_273517_);
      this.placeSand(i, j + 1, k - 3, p_273517_);
      this.placeSand(i, j + 2, k - 3, p_273517_);
   ...
   private void placeSand(int p_273469_, int p_272983_, int p_273325_, BoundingBox p_272909_) {
      BlockPos blockpos = this.getWorldPos(p_273469_, p_272983_, p_273325_);
      if (p_272909_.isInside(blockpos)) {
         this.potentialSuspiciousSandWorldPositions.add(blockpos);
      }

   }

   private void placeSandBox(BoundingBox p_272934_, int p_273391_, int p_273481_, int p_273347_, int p_273463_, int p_272814_, int p_273011_) {
      for(int i = p_273481_; i <= p_272814_; ++i) {
         for(int j = p_273391_; j <= p_273463_; ++j) {
            for(int k = p_273347_; k <= p_273011_; ++k) {
               this.placeSand(j, i, k, p_272934_);
            }
         }
      }
   ...
   private void placeCollapsedRoofPiece(WorldGenLevel p_272965_, int p_272618_, int p_273415_, int p_273110_, BoundingBox p_272645_) {
      if (p_272965_.getRandom().nextBoolean()) {
