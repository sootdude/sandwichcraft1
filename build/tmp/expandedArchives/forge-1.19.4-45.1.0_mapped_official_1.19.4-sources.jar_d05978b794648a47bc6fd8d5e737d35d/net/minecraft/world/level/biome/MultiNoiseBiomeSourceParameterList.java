...
public class MultiNoiseBiomeSourceParameterList {
   ...
   public static record Preset(ResourceLocation id, MultiNoiseBiomeSourceParameterList.Preset.SourceProvider provider) {
      ...
      public static final MultiNoiseBiomeSourceParameterList.Preset OVERWORLD_UPDATE_1_20 = new MultiNoiseBiomeSourceParameterList.Preset(new ResourceLocation("overworld_update_1_20"), new MultiNoiseBiomeSourceParameterList.Preset.SourceProvider() {
         public <T> Climate.ParameterList<T> apply(Function<ResourceKey<Biome>, T> p_275719_) {
            return MultiNoiseBiomeSourceParameterList.Preset.generateOverworldBiomes(p_275719_, OverworldBiomeBuilder.Modifier.UPDATE_1_20);
         }
      });
      static final Map<ResourceLocation, MultiNoiseBiomeSourceParameterList.Preset> BY_NAME = Stream.of(NETHER, OVERWORLD, OVERWORLD_UPDATE_1_20).collect(Collectors.toMap(MultiNoiseBiomeSourceParameterList.Preset::id, (p_275365_) -> {
         return p_275365_;
      }));
      ...
      static <T> Climate.ParameterList<T> generateOverworldBiomes(Function<ResourceKey<Biome>, T> p_275249_, OverworldBiomeBuilder.Modifier p_275234_) {
         ImmutableList.Builder<Pair<Climate.ParameterPoint, T>> builder = ImmutableList.builder();
         (new OverworldBiomeBuilder(p_275234_)).addBiomes((p_275579_) -> {
