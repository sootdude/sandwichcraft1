   ...
   protected void apply(Map<ResourceLocation, JsonElement> p_79214_, ResourceManager p_79215_, ProfilerFiller p_79216_) {
      ...
      p_79214_.forEach((p_79198_, p_79199_) -> {
         try {
            ...
            LootTable loottable = net.minecraftforge.common.ForgeHooks.loadLootTable(GSON, p_79198_, p_79199_, res == null || !res.sourcePackId().equals(net.minecraft.server.packs.repository.BuiltInPackSource.VANILLA_ID), this);
