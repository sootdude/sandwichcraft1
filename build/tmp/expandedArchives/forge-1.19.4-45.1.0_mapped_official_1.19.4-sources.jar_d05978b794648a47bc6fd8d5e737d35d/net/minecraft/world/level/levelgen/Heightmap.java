...
public class Heightmap {
   ...
   public static enum Types implements StringRepresentable {
      ...
      MOTION_BLOCKING("MOTION_BLOCKING", Heightmap.Usage.CLIENT, (p_272569_) -> {
         return p_272569_.getMaterial().blocksMotion() || !p_272569_.getFluidState().isEmpty();
      }),
      MOTION_BLOCKING_NO_LEAVES("MOTION_BLOCKING_NO_LEAVES", Heightmap.Usage.LIVE_WORLD, (p_272568_) -> {
         return (p_272568_.getMaterial().blocksMotion() || !p_272568_.getFluidState().isEmpty()) && !(p_272568_.getBlock() instanceof LeavesBlock);
      });
