...
public class AnimalPanic extends Behavior<PathfinderMob> {
   ...
   private static final Predicate<PathfinderMob> DEFAULT_SHOULD_PANIC_PREDICATE = (p_275910_) -> {
      return p_275910_.getLastHurtByMob() != null || p_275910_.isFreezing() || p_275910_.isOnFire();
   };
