...
public class GoatAi {
   ...
   private static final TargetingConditions RAM_TARGET_CONDITIONS = TargetingConditions.forCombat().selector((p_275110_) -> {
      return !p_275110_.getType().equals(EntityType.GOAT) && p_275110_.level.getWorldBorder().isWithinBounds(p_275110_.getBoundingBox());
   });
   ...
   private static void initRamActivity(Brain<Goat> p_149466_) {
      ...
      }, RAM_TARGET_CONDITIONS, 3.0F, (p_269931_) -> {
         return p_269931_.isBaby() ? 1.0D : 2.5D;
      }, (p_149468_) -> {
