...
public class Panda extends Animal {
   ...
   static final Predicate<ItemEntity> PANDA_ITEMS = (p_275106_) -> {
      ItemStack itemstack = p_275106_.getItem();
      return (itemstack.is(Blocks.BAMBOO.asItem()) || itemstack.is(Blocks.CAKE.asItem())) && p_275106_.isAlive() && !p_275106_.hasPickUpDelay();
   };
