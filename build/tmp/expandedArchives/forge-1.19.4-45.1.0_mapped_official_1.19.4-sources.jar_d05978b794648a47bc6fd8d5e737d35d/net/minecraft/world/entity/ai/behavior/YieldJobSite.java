            ...
            return (p_258912_, p_258913_, p_258914_) -> {
               if (p_258913_.isBaby()) {
                  ...
                  if (optional.isEmpty()) {
                     ...
                     }).findFirst().ifPresent((p_269894_) -> {
                        p_258904_.erase();
                        p_258905_.erase();
                        p_258901_.erase();
                        if (p_269894_.getBrain().getMemory(MemoryModuleType.JOB_SITE).isEmpty()) {
                           BehaviorUtils.setWalkAndLookTargetMemories(p_269894_, blockpos, p_259768_, 1);
                           p_269894_.getBrain().setMemory(MemoryModuleType.POTENTIAL_JOB_SITE, GlobalPos.of(p_258912_.dimension(), blockpos));
