...
public class InteractWithDoor {
   ...
   private static boolean areOtherMobsComingThroughDoor(LivingEntity p_260091_, BlockPos p_259764_, Optional<List<LivingEntity>> p_259365_) {
      return p_259365_.isEmpty() ? false : p_259365_.get().stream().filter((p_274986_) -> {
         return p_274986_.getType() == p_260091_.getType();
      }).filter((p_275919_) -> {
         return p_259764_.closerToCenterThan(p_275919_.position(), 2.0D);
      }).anyMatch((p_258454_) -> {
