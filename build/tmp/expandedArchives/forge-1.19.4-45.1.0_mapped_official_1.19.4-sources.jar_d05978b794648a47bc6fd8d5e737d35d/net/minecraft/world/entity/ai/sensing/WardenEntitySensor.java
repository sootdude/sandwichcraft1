...
public class WardenEntitySensor extends NearestLivingEntitySensor<Warden> {
   ...
   protected void doTick(ServerLevel p_217833_, Warden p_217834_) {
      ...
      getClosest(p_217834_, (p_275077_) -> {
         return p_275077_.getType() == EntityType.PLAYER;
      }).or(() -> {
         return getClosest(p_217834_, (p_275076_) -> {
            return p_275076_.getType() != EntityType.PLAYER;
         });
