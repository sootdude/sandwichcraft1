...
public class WanderingTrader extends AbstractVillager {
   ...
   protected void registerGoals() {
      ...
      this.goalSelector.addGoal(0, new UseItemGoal<>(this, PotionUtils.setPotion(new ItemStack(Items.POTION), Potions.INVISIBILITY), SoundEvents.WANDERING_TRADER_DISAPPEARED, (p_272518_) -> {
         return this.level.isNight() && !p_272518_.isInvisible();
      }));
      this.goalSelector.addGoal(0, new UseItemGoal<>(this, new ItemStack(Items.MILK_BUCKET), SoundEvents.WANDERING_TRADER_REAPPEARED, (p_272519_) -> {
         return this.level.isDay() && p_272519_.isInvisible();
      }));
