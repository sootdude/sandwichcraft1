...
public class AnimalMakeLove extends Behavior<Animal> {
   ...
   private Optional<? extends Animal> findValidBreedPartner(Animal p_22432_) {
      return p_22432_.getBrain().getMemory(MemoryModuleType.NEAREST_VISIBLE_LIVING_ENTITIES).get().findClosest((p_274963_) -> {
         if (p_274963_.getType() == this.partnerType && p_274963_ instanceof Animal animal) {
