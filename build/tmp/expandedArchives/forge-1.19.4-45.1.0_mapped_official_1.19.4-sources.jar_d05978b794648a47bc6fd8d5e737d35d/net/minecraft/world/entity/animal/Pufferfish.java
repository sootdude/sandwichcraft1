...
public class Pufferfish extends AbstractFish {
   ...
   int inflateCounter;
   int deflateTimer;
   private static final Predicate<LivingEntity> SCARY_MOB = (p_275107_) -> {
      if (p_275107_ instanceof Player && ((Player)p_275107_).isCreative()) {
         return false;
      } else {
         return p_275107_.getType() == EntityType.AXOLOTL || p_275107_.getMobType() != MobType.WATER;
      }
   };
