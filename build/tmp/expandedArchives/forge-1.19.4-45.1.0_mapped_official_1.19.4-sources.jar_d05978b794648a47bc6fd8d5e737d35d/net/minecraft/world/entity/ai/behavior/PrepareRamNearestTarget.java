...
public class PrepareRamNearestTarget<E extends PathfinderMob> extends Behavior<E> {
   ...
   private void chooseRamPosition(PathfinderMob p_147766_, LivingEntity p_147767_) {
      ...
      this.ramCandidate = this.calculateRammingStartPosition(p_147766_, p_147767_).map((p_275957_) -> {
         return new PrepareRamNearestTarget.RamCandidate(p_275957_, p_147767_.blockPosition(), p_147767_);
      });
   }
