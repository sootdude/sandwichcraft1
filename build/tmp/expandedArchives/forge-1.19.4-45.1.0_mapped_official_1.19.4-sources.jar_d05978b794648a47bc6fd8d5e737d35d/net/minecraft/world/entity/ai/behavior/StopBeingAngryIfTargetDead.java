      ...
      return BehaviorBuilder.create((p_258814_) -> {
         return p_258814_.group(p_258814_.present(MemoryModuleType.ANGRY_AT)).apply(p_258814_, (p_258813_) -> {
            return (p_258807_, p_258808_, p_258809_) -> {
               ...
               }).filter(LivingEntity::isDeadOrDying).filter((p_275063_) -> {
                  return p_275063_.getType() != EntityType.PLAYER || p_258807_.getGameRules().getBoolean(GameRules.RULE_FORGIVE_DEAD_PLAYERS);
               }).ifPresent((p_258811_) -> {
                  p_258813_.erase();
               });
               return true;
