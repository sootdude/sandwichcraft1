...
public abstract class Raider extends PatrollingMonster {
   ...
   static final Predicate<ItemEntity> ALLOWED_ITEMS = (p_275140_) -> {
      return !p_275140_.hasPickUpDelay() && p_275140_.isAlive() && ItemStack.matches(p_275140_.getItem(), Raid.getLeaderBannerInstance());
   };
   @Nullable
   protected Raid raid;
   private int wave;
