...
public class SmithingMenu extends ItemCombinerMenu {
   ...
   protected ItemCombinerMenuSlotDefinition createInputSlotDefinitions() {
      ...
      }).withSlot(1, 26, 48, (p_266636_) -> {
         return this.recipes.stream().anyMatch((p_266645_) -> {
            return p_266645_.isBaseIngredient(p_266636_) && p_266645_.isTemplateIngredient(this.slots.get(0).getItem());
         });
      }).withSlot(2, 44, 48, (p_266648_) -> {
         return this.recipes.stream().anyMatch((p_266638_) -> {
            return p_266638_.isAdditionIngredient(p_266648_) && p_266638_.isTemplateIngredient(this.slots.get(0).getItem());
         });
