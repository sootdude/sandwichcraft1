...
public class DecoratedPotRecipe extends CustomRecipe {
   ...
   public ItemStack assemble(CraftingContainer p_272861_, RegistryAccess p_273288_) {
      ...
      DecoratedPotBlockEntity.saveShards(List.of(p_272861_.getItem(1).getItem(), p_272861_.getItem(3).getItem(), p_272861_.getItem(5).getItem(), p_272861_.getItem(7).getItem()), compoundtag);
