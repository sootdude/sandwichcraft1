...
public class BottleItem extends Item {
   ...
   public InteractionResultHolder<ItemStack> use(Level p_40656_, Player p_40657_, InteractionHand p_40658_) {
      List<AreaEffectCloud> list = p_40656_.getEntitiesOfClass(AreaEffectCloud.class, p_40657_.getBoundingBox().inflate(2.0D), (p_275145_) -> {
         return p_275145_ != null && p_275145_.isAlive() && p_275145_.getOwner() instanceof EnderDragon;
      });
