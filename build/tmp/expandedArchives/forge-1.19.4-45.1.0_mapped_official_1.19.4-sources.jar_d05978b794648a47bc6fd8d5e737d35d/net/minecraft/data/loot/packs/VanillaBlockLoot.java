...
public class VanillaBlockLoot extends BlockLootSubProvider {
   ...
   protected void generate() {
      ...
      this.add(Blocks.BRICK_SLAB, (p_250363_) -> {
         return this.createSlabItemTable(p_250363_);
      });
      this.add(Blocks.COBBLESTONE_SLAB, (p_249255_) -> {
         return this.createSlabItemTable(p_249255_);
      });
      this.add(Blocks.DARK_PRISMARINE_SLAB, (p_249820_) -> {
         return this.createSlabItemTable(p_249820_);
      });
      this.add(Blocks.NETHER_BRICK_SLAB, (p_250846_) -> {
         return this.createSlabItemTable(p_250846_);
      });
      this.add(Blocks.PRISMARINE_BRICK_SLAB, (p_249031_) -> {
         return this.createSlabItemTable(p_249031_);
      });
      this.add(Blocks.PRISMARINE_SLAB, (p_251560_) -> {
         return this.createSlabItemTable(p_251560_);
      });
      this.add(Blocks.PURPUR_SLAB, (p_250571_) -> {
         return this.createSlabItemTable(p_250571_);
      });
      this.add(Blocks.QUARTZ_SLAB, (p_250698_) -> {
         return this.createSlabItemTable(p_250698_);
      });
      this.add(Blocks.RED_SANDSTONE_SLAB, (p_250985_) -> {
         return this.createSlabItemTable(p_250985_);
      });
      this.add(Blocks.SANDSTONE_SLAB, (p_250829_) -> {
         return this.createSlabItemTable(p_250829_);
      });
      this.add(Blocks.CUT_RED_SANDSTONE_SLAB, (p_251720_) -> {
         return this.createSlabItemTable(p_251720_);
      });
      this.add(Blocks.CUT_SANDSTONE_SLAB, (p_249342_) -> {
         return this.createSlabItemTable(p_249342_);
      });
      this.add(Blocks.STONE_BRICK_SLAB, (p_250259_) -> {
         return this.createSlabItemTable(p_250259_);
      });
      this.add(Blocks.STONE_SLAB, (p_251501_) -> {
         return this.createSlabItemTable(p_251501_);
      });
      this.add(Blocks.SMOOTH_STONE_SLAB, (p_250933_) -> {
         return this.createSlabItemTable(p_250933_);
      });
      this.add(Blocks.POLISHED_GRANITE_SLAB, (p_248836_) -> {
         return this.createSlabItemTable(p_248836_);
      });
      this.add(Blocks.SMOOTH_RED_SANDSTONE_SLAB, (p_252142_) -> {
         return this.createSlabItemTable(p_252142_);
      });
      this.add(Blocks.MOSSY_STONE_BRICK_SLAB, (p_248657_) -> {
         return this.createSlabItemTable(p_248657_);
      });
      this.add(Blocks.POLISHED_DIORITE_SLAB, (p_249451_) -> {
         return this.createSlabItemTable(p_249451_);
      });
      this.add(Blocks.MOSSY_COBBLESTONE_SLAB, (p_249500_) -> {
         return this.createSlabItemTable(p_249500_);
      });
      this.add(Blocks.END_STONE_BRICK_SLAB, (p_249589_) -> {
         return this.createSlabItemTable(p_249589_);
      });
      this.add(Blocks.SMOOTH_SANDSTONE_SLAB, (p_251378_) -> {
         return this.createSlabItemTable(p_251378_);
      });
      this.add(Blocks.SMOOTH_QUARTZ_SLAB, (p_251340_) -> {
         return this.createSlabItemTable(p_251340_);
      });
      this.add(Blocks.GRANITE_SLAB, (p_252148_) -> {
         return this.createSlabItemTable(p_252148_);
      });
      this.add(Blocks.ANDESITE_SLAB, (p_248742_) -> {
         return this.createSlabItemTable(p_248742_);
      });
      this.add(Blocks.RED_NETHER_BRICK_SLAB, (p_252320_) -> {
         return this.createSlabItemTable(p_252320_);
      });
      this.add(Blocks.POLISHED_ANDESITE_SLAB, (p_249683_) -> {
         return this.createSlabItemTable(p_249683_);
      });
      this.add(Blocks.DIORITE_SLAB, (p_249813_) -> {
         return this.createSlabItemTable(p_249813_);
      });
      this.add(Blocks.CRIMSON_SLAB, (p_250170_) -> {
         return this.createSlabItemTable(p_250170_);
      });
      this.add(Blocks.WARPED_SLAB, (p_249068_) -> {
         return this.createSlabItemTable(p_249068_);
      });
      this.add(Blocks.BLACKSTONE_SLAB, (p_251963_) -> {
         return this.createSlabItemTable(p_251963_);
      });
      this.add(Blocks.POLISHED_BLACKSTONE_BRICK_SLAB, (p_250291_) -> {
         return this.createSlabItemTable(p_250291_);
      });
      this.add(Blocks.POLISHED_BLACKSTONE_SLAB, (p_251741_) -> {
         return this.createSlabItemTable(p_251741_);
      });
      this.add(Blocks.OXIDIZED_CUT_COPPER_SLAB, (p_249431_) -> {
         return this.createSlabItemTable(p_249431_);
      });
      this.add(Blocks.WEATHERED_CUT_COPPER_SLAB, (p_249660_) -> {
         return this.createSlabItemTable(p_249660_);
      });
      this.add(Blocks.EXPOSED_CUT_COPPER_SLAB, (p_249229_) -> {
         return this.createSlabItemTable(p_249229_);
      });
      this.add(Blocks.CUT_COPPER_SLAB, (p_251568_) -> {
         return this.createSlabItemTable(p_251568_);
      });
      this.add(Blocks.WAXED_OXIDIZED_CUT_COPPER_SLAB, (p_248799_) -> {
         return this.createSlabItemTable(p_248799_);
      });
      this.add(Blocks.WAXED_WEATHERED_CUT_COPPER_SLAB, (p_249358_) -> {
         return this.createSlabItemTable(p_249358_);
      });
      this.add(Blocks.WAXED_EXPOSED_CUT_COPPER_SLAB, (p_252044_) -> {
         return this.createSlabItemTable(p_252044_);
      });
      this.add(Blocks.WAXED_CUT_COPPER_SLAB, (p_251336_) -> {
         return this.createSlabItemTable(p_251336_);
      });
      this.add(Blocks.COBBLED_DEEPSLATE_SLAB, (p_251951_) -> {
         return this.createSlabItemTable(p_251951_);
      });
      this.add(Blocks.POLISHED_DEEPSLATE_SLAB, (p_250882_) -> {
         return this.createSlabItemTable(p_250882_);
      });
      this.add(Blocks.DEEPSLATE_TILE_SLAB, (p_249866_) -> {
         return this.createSlabItemTable(p_249866_);
      });
      this.add(Blocks.DEEPSLATE_BRICK_SLAB, (p_252348_) -> {
         return this.createSlabItemTable(p_252348_);
      });
      this.add(Blocks.MUD_BRICK_SLAB, (p_248980_) -> {
      ...
      this.add(Blocks.OAK_LEAVES, (p_251165_) -> {
         return this.createOakLeavesDrops(p_251165_, Blocks.OAK_SAPLING, NORMAL_LEAVES_SAPLING_CHANCES);
      });
      this.add(Blocks.SPRUCE_LEAVES, (p_251695_) -> {
         return this.createLeavesDrops(p_251695_, Blocks.SPRUCE_SAPLING, NORMAL_LEAVES_SAPLING_CHANCES);
      });
      this.add(Blocks.BIRCH_LEAVES, (p_249592_) -> {
         return this.createLeavesDrops(p_249592_, Blocks.BIRCH_SAPLING, NORMAL_LEAVES_SAPLING_CHANCES);
      });
      ...
      this.add(Blocks.ACACIA_LEAVES, (p_249163_) -> {
         return this.createLeavesDrops(p_249163_, Blocks.ACACIA_SAPLING, NORMAL_LEAVES_SAPLING_CHANCES);
      });
      this.add(Blocks.DARK_OAK_LEAVES, (p_249663_) -> {
         return this.createOakLeavesDrops(p_249663_, Blocks.DARK_OAK_SAPLING, NORMAL_LEAVES_SAPLING_CHANCES);
      });
      this.add(Blocks.CHERRY_LEAVES, (p_272368_) -> {
         return noDrop();
      });
      this.add(Blocks.AZALEA_LEAVES, (p_251404_) -> {
         return this.createLeavesDrops(p_251404_, Blocks.AZALEA, NORMAL_LEAVES_SAPLING_CHANCES);
      });
      this.add(Blocks.FLOWERING_AZALEA_LEAVES, (p_248789_) -> {
         return this.createLeavesDrops(p_248789_, Blocks.FLOWERING_AZALEA, NORMAL_LEAVES_SAPLING_CHANCES);
      });
