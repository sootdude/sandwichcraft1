...
public class UpdateOneTwentyBlockTagsProvider extends IntrinsicHolderTagsProvider<Block> {
   public UpdateOneTwentyBlockTagsProvider(PackOutput p_275306_, CompletableFuture<HolderLookup.Provider> p_275684_, CompletableFuture<TagsProvider.TagLookup<Block>> p_275442_) {
      super(p_275306_, Registries.BLOCK, p_275684_, p_275442_, (p_256110_) -> {
         return p_256110_.builtInRegistryHolder().key();
      });
   }

   protected void addTags(HolderLookup.Provider p_256304_) {
      ...
      this.tag(BlockTags.MINEABLE_WITH_AXE).addTag(BlockTags.ALL_HANGING_SIGNS).add(Blocks.BAMBOO_MOSAIC, Blocks.BAMBOO_MOSAIC_SLAB, Blocks.BAMBOO_MOSAIC_STAIRS).addTag(BlockTags.BAMBOO_BLOCKS).add(Blocks.CHISELED_BOOKSHELF);
      this.tag(BlockTags.SNIFFER_DIGGABLE_BLOCK).add(Blocks.DIRT, Blocks.GRASS_BLOCK, Blocks.PODZOL, Blocks.COARSE_DIRT, Blocks.ROOTED_DIRT, Blocks.MOSS_BLOCK, Blocks.MUD, Blocks.MUDDY_MANGROVE_ROOTS);
