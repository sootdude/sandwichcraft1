...
public class MatrixUtil {
   ...
   public static Triple<Quaternionf, Vector3f, Quaternionf> svdDecompose(Matrix3f p_253947_) {
      ...
      boolean flag = (double)matrix3f.m00 < 1.0E-6D;
      boolean flag1 = (double)matrix3f.m11 < 1.0E-6D;
      ...
      f = 1.0F / f;
      quaternionf1.mul(Math.sqrt(f));
      Vector3f vector3f = new Vector3f(matrix3f4.m00 * f, matrix3f4.m11 * f, matrix3f4.m22 * f);
