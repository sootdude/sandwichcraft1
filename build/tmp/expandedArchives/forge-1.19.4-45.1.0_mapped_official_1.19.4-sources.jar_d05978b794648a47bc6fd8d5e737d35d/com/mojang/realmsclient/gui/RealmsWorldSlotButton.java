...
public class RealmsWorldSlotButton extends Button {
   ...
   public void renderWidget(PoseStack p_87964_, int p_87965_, int p_87966_, float p_87967_) {
      if (this.state != null) {
         this.drawSlotFrame(p_87964_, this.getX(), this.getY(), p_87965_, p_87966_, this.state.isCurrentlyActiveSlot, this.state.slotName, this.slotIndex, this.state.imageId, this.state.image, this.state.empty, this.state.minigame, this.state.action, this.state.actionPrompt);
      }
   }
   ...
   private void drawSlotFrame(PoseStack p_87939_, int p_87940_, int p_87941_, int p_87942_, int p_87943_, boolean p_87944_, String p_87945_, int p_87946_, long p_87947_, @Nullable String p_87948_, boolean p_87949_, boolean p_87950_, RealmsWorldSlotButton.Action p_87951_, @Nullable Component p_87952_) {
      ...
      if (p_87950_) {
         RenderSystem.setShaderTexture(0, RealmsTextureManager.worldTemplate(String.valueOf(p_87947_), p_87948_));
      } else if (p_87949_) {
