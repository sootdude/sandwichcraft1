...
public class RealmsPlayerScreen extends RealmsScreen {
   ...
   public void init() {
      ...
      this.addRenderableWidget(Button.builder(Component.translatable("mco.configure.world.buttons.invite"), (p_89176_) -> {
         this.minecraft.setScreen(new RealmsInviteScreen(this.lastScreen, this, this.serverData));
      }).bounds(this.column2X, row(1), this.columnWidth + 10, 20).build());
      this.removeButton = this.addRenderableWidget(Button.builder(Component.translatable("mco.configure.world.invites.remove.tooltip"), (p_89161_) -> {
         this.uninvite(this.player);
      }).bounds(this.column2X, row(7), this.columnWidth + 10, 20).build());
      this.opdeopButton = this.addRenderableWidget(Button.builder(Component.translatable("mco.configure.world.invites.ops.tooltip"), (p_89139_) -> {
      ...
      }).bounds(this.column2X + this.columnWidth / 2 + 2, row(12), this.columnWidth / 2 + 10 - 2, 20).build());
   ...
   public void render(PoseStack p_89098_, int p_89099_, int p_89100_, float p_89101_) {
      ...
      blit(p_89098_, 0, i, 0.0F, 0.0F, this.width, this.height - i, 32, 32);
   ...
   protected void renderMousehoverTooltip(PoseStack p_89103_, @Nullable Component p_89104_, int p_89105_, int p_89106_) {
      if (p_89104_ != null) {
         ...
         fillGradient(p_89103_, i - 3, j - 3, i + k + 3, j + 8 + 3, -1073741824, -1073741824);
   ...
   class Entry extends ObjectSelectionList.Entry<RealmsPlayerScreen.Entry> {
      ...
      private void renderInvitedItem(PoseStack p_89220_, PlayerInfo p_89221_, int p_89222_, int p_89223_, int p_89224_, int p_89225_) {
         ...
         RealmsUtil.renderPlayerFace(p_89220_, RealmsPlayerScreen.this.column1X + 2 + 2, p_89223_ + 1, 8, p_89221_.getUuid());
      }
   ...
   class InvitedObjectSelectionList extends RealmsObjectSelectionList<RealmsPlayerScreen.Entry> {
      ...
      public boolean mouseClicked(double p_89230_, double p_89231_, int p_89232_) {
         if (p_89232_ == 0 && p_89230_ < (double)this.getScrollbarPosition() && p_89231_ >= (double)this.y0 && p_89231_ <= (double)this.y1) {
            ...
            if (p_89230_ >= (double)i && p_89230_ <= (double)j && l >= 0 && k >= 0 && l < this.getItemCount()) {
               this.selectItem(l);
               this.itemClicked(k, l, p_89230_, p_89231_, this.width, p_89232_);
            }
      ...
      public void itemClicked(int p_89236_, int p_89237_, double p_89238_, double p_89239_, int p_89240_, int p_275629_) {
