...
public class RealmsResetWorldScreen extends RealmsScreen {
   ...
   public void init() {
      this.addRenderableWidget(Button.builder(this.buttonTitle, (p_89419_) -> {
   ...
   class FrameButton extends Button {
      ...
      public void renderWidget(PoseStack p_89445_, int p_89446_, int p_89447_, float p_89448_) {
         RealmsResetWorldScreen.this.drawFrame(p_89445_, this.getX(), this.getY(), this.getMessage(), this.image, this.isHoveredOrFocused(), this.isMouseOver((double)p_89446_, (double)p_89447_));
      }
   }
}