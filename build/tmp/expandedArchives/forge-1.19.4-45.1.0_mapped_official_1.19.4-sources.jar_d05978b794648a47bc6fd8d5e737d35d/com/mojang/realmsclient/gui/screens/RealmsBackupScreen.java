...
public class RealmsBackupScreen extends RealmsScreen {
   ...
   public void init() {
      ...
      this.changesButton = this.addRenderableWidget(Button.builder(Component.translatable("mco.backup.changes.tooltip"), (p_88174_) -> {
      ...
      this.addRenderableWidget(Button.builder(CommonComponents.GUI_BACK, (p_88164_) -> {
   ...
   protected void renderMousehoverTooltip(PoseStack p_88142_, @Nullable Component p_88143_, int p_88144_, int p_88145_) {
      if (p_88143_ != null) {
         ...
         fillGradient(p_88142_, i - 3, j - 3, i + k + 3, j + 8 + 3, -1073741824, -1073741824);
   ...
   class BackupObjectSelectionList extends RealmsObjectSelectionList<RealmsBackupScreen.Entry> {
      ...
      public boolean mouseClicked(double p_88221_, double p_88222_, int p_88223_) {
         if (p_88223_ != 0) {
            ...
            if (p_88221_ >= (double)i && p_88221_ <= (double)j && l >= 0 && k >= 0 && l < this.getItemCount()) {
               this.selectItem(l);
               this.itemClicked(k, l, p_88221_, p_88222_, this.width, p_88223_);
            }
      ...
      public void itemClicked(int p_88227_, int p_88228_, double p_88229_, double p_88230_, int p_88231_, int p_275225_) {
         int i = this.width - 35;
