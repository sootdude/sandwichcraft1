...
public class RealmsInviteScreen extends RealmsScreen {
   ...
   public void init() {
      ...
      this.addRenderableWidget(Button.builder(Component.translatable("mco.configure.world.buttons.invite"), (p_88721_) -> {
         this.onInvite();
      }).bounds(this.width / 2 - 100, row(10), 200, 20).build());
      this.addRenderableWidget(Button.builder(CommonComponents.GUI_CANCEL, (p_88716_) -> {
