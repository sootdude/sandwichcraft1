...
public class RealmsBrokenWorldScreen extends RealmsScreen {
   ...
   private void addButtons() {
      for(Map.Entry<Integer, RealmsWorldOptions> entry : this.serverData.slots.entrySet()) {
         ...
         if (flag) {
            ...
            button = Button.builder(Component.translatable("mco.brokenworld.download"), (p_88339_) -> {
         ...
         this.addRenderableWidget(Button.builder(Component.translatable("mco.brokenworld.reset"), (p_88309_) -> {
   ...
   private void downloadWorld(int p_88336_) {
      ...
      try {
         ...
         RealmsDownloadLatestWorldScreen realmsdownloadlatestworldscreen = new RealmsDownloadLatestWorldScreen(this, worlddownload, this.serverData.getWorldName(p_88336_), (p_276231_) -> {
            if (p_276231_) {
   ...
   private void drawSlotFrame(PoseStack p_88321_, int p_88322_, int p_88323_, int p_88324_, int p_88325_, boolean p_88326_, String p_88327_, int p_88328_, long p_88329_, @Nullable String p_88330_, boolean p_88331_) {
      if (p_88331_) {
         ...
         RenderSystem.setShaderTexture(0, RealmsTextureManager.worldTemplate(String.valueOf(p_88329_), p_88330_));
      } else if (p_88328_ == 1) {
