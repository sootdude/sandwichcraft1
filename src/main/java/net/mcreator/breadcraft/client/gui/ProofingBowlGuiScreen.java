...
public class ProofingBowlGuiScreen extends AbstractContainerScreen<ProofingBowlGuiMenu> {
	...
	protected void renderBg(PoseStack ms, float partialTicks, int gx, int gy) {
		...
		Doughbar1Procedure.execute(world, x, y, z)
		...
		Doughbar2Procedure.execute(world, x, y, z)
		...
		Doughbar3Procedure.execute(world, x, y, z)
		...
		Doughbar4Procedure.execute(world, x, y, z)
		...
		Doughbar5Procedure.execute(world, x, y, z)
		...
		Doughbar6Procedure.execute(world, x, y, z)
		...
		Doughbar7Procedure.execute(world, x, y, z)
		...
		Doughbar8Procedure.execute(world, x, y, z)
		...
		Doughbar9Procedure.execute(world, x, y, z)
		...
		Doughbar10Procedure.execute(world, x, y, z)
		...
		Doughbar11Procedure.execute(world, x, y, z)
		...
		Doughbar13Procedure.execute(world, x, y, z)
