...
public class CaperStage0TrampledProcedure {
	@SubscribeEvent
	...
	private static void execute(@Nullable Event event, LevelAccessor world, double x, double y, double z) {
		...
		stage0 = BreadcraftModBlocks.CAPER_STAGE_0.get().defaultBlockState();
		stage1 = BreadcraftModBlocks.CAPER_STAGE_1.get().defaultBlockState();
		stage2 = BreadcraftModBlocks.CAPER_STAGE_2.get().defaultBlockState();
		stage3 = BreadcraftModBlocks.CAPER_STAGE_3.get().defaultBlockState();
		stage4 = BreadcraftModBlocks.CAPER_STAGE_4.get().defaultBlockState();
		stage5 = BreadcraftModBlocks.CAPER_STAGE_5.get().defaultBlockState();
		stage6 = BreadcraftModBlocks.CAPER_STAGE_6.get().defaultBlockState();
