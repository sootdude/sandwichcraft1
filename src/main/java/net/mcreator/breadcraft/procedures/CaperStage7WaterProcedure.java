...
public class CaperStage7WaterProcedure {
	@SubscribeEvent
	...
	private static void execute(@Nullable Event event, LevelAccessor world, double x, double y, double z) {
		...
		capers7 = BreadcraftModBlocks.CAPER_STAGE_7.get().defaultBlockState();
		itemSeed = new ItemStack(BreadcraftModItems.CAPER_SEEDS.get());
		itemCrop = new ItemStack(BreadcraftModItems.CAPER_LEAVES.get());
		if ((world.getBlockState(BlockPos.containing(x, y + 1, z))).getBlock() == capers7.getBlock()) {
