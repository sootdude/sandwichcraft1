...
public class RosemaryStage0TrampledProcedure {
	@SubscribeEvent
	...
	private static void execute(@Nullable Event event, LevelAccessor world, double x, double y, double z) {
		...
		stage0 = BreadcraftModBlocks.ROSEMARY_STAGE_0.get().defaultBlockState();
		stage1 = BreadcraftModBlocks.ROSEMARY_STAGE_1.get().defaultBlockState();
		stage2 = BreadcraftModBlocks.ROSEMARY_STAGE_2.get().defaultBlockState();
		stage3 = BreadcraftModBlocks.ROSEMARY_STAGE_3.get().defaultBlockState();
		stage4 = BreadcraftModBlocks.ROSEMARY_STAGE_4.get().defaultBlockState();
		stage5 = BreadcraftModBlocks.ROSEMARY_STAGE_5.get().defaultBlockState();
		stage6 = BreadcraftModBlocks.ROSEMARY_STAGE_6.get().defaultBlockState();
		itemSeed = new ItemStack(BreadcraftModItems.ROSEMARY_SEEDS.get());
