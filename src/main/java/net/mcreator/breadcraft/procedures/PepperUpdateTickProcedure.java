...
public class PepperUpdateTickProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z) {
		...
		logicLightGrowthCondition = PepperLightGrowthConditionProcedure.execute(world, x, y, z);
		numberGrowthCondition = PepperGrowthScoreConditionProcedure.execute(world, x, y, z);
		blockSoulSand = Blocks.SOUL_SAND.defaultBlockState();
		blockFarmland = Blocks.FARMLAND.defaultBlockState();
		blockStage0 = BreadcraftModBlocks.PEPPER_STAGE_0.get().defaultBlockState();
		blockStage1 = BreadcraftModBlocks.PEPPER_STAGE_1.get().defaultBlockState();
		blockStage2 = BreadcraftModBlocks.PEPPER_STAGE_2.get().defaultBlockState();
		blockStage3 = BreadcraftModBlocks.PEPPER_STAGE_3.get().defaultBlockState();
		blockStage4 = BreadcraftModBlocks.PEPPER_STAGE_4.get().defaultBlockState();
		blockStage5 = BreadcraftModBlocks.PEPPER_STAGE_5.get().defaultBlockState();
		blockStage6 = BreadcraftModBlocks.PEPPER_STAGE_6.get().defaultBlockState();
		...
		if (canDrop == true) {
			if (logicDropType == true) {
				PepperStage0ExplodedProcedure.execute(world, x, y, z);
			} else {
				PepperStage7ExplodedProcedure.execute(world, x, y, z);
			}
		}
	}
}
