...
public class RyeStage0TrampledProcedure {
	@SubscribeEvent
	...
	private static void execute(@Nullable Event event, LevelAccessor world, double x, double y, double z) {
		...
		stage0 = BreadcraftModBlocks.STAGE_0.get().defaultBlockState();
		stage1 = BreadcraftModBlocks.STAGE_1.get().defaultBlockState();
		stage2 = BreadcraftModBlocks.STAGE_2.get().defaultBlockState();
		stage3 = BreadcraftModBlocks.STAGE_3.get().defaultBlockState();
		stage4 = BreadcraftModBlocks.STAGE_4.get().defaultBlockState();
		stage5 = BreadcraftModBlocks.STAGE_5.get().defaultBlockState();
		stage6 = BreadcraftModBlocks.STAGE_6.get().defaultBlockState();
