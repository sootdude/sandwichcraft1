...
public class TomatoStage0TrampledProcedure {
	@SubscribeEvent
	...
	private static void execute(@Nullable Event event, LevelAccessor world, double x, double y, double z) {
		...
		stage0 = BreadcraftModBlocks.TOMATO_STAGE_0.get().defaultBlockState();
		stage1 = BreadcraftModBlocks.TOMATO_STAGE_1.get().defaultBlockState();
		stage2 = BreadcraftModBlocks.TOMATO_STAGE_2.get().defaultBlockState();
		stage3 = BreadcraftModBlocks.TOMATO_STAGE_3.get().defaultBlockState();
		stage4 = BreadcraftModBlocks.TOMATO_STAGE_4.get().defaultBlockState();
		stage5 = BreadcraftModBlocks.TOMATO_STAGE_5.get().defaultBlockState();
		stage6 = BreadcraftModBlocks.TOMATO_STAGE_6.get().defaultBlockState();
