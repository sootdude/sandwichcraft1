...
public class OnionUpdateTickProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z) {
		...
		logicLightGrowthCondition = OnionLightGrowthConditionProcedure.execute(world, x, y, z);
		numberGrowthCondition = OnionGrowthScoreConditionProcedure.execute(world, x, y, z);
		blockSoulSand = Blocks.SOUL_SAND.defaultBlockState();
		blockFarmland = Blocks.FARMLAND.defaultBlockState();
		blockStage0 = BreadcraftModBlocks.ONION_STAGE_0.get().defaultBlockState();
		blockStage1 = BreadcraftModBlocks.ONION_STAGE_1.get().defaultBlockState();
		blockStage2 = BreadcraftModBlocks.ONION_STAGE_2.get().defaultBlockState();
		blockStage3 = BreadcraftModBlocks.ONION_STAGE_3.get().defaultBlockState();
		blockStage4 = BreadcraftModBlocks.ONION_STAGE_4.get().defaultBlockState();
		blockStage5 = BreadcraftModBlocks.ONION_STAGE_5.get().defaultBlockState();
		blockStage6 = BreadcraftModBlocks.ONION_STAGE_6.get().defaultBlockState();
		blockStage7 = BreadcraftModBlocks.ONION_STAGE_7.get().defaultBlockState();
		...
		if (canDrop == true) {
			if (logicDropType == true) {
				OnionStage0DestroyedByExplosionProcedure.execute(world, x, y, z);
			} else {
				OnionStage7DestroyedByExplosionProcedure.execute(world, x, y, z);
			}
		}
	}
}
