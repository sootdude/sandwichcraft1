...
public class PeanutStage0TrampledProcedure {
	@SubscribeEvent
	...
	private static void execute(@Nullable Event event, LevelAccessor world, double x, double y, double z) {
		...
		stage0 = BreadcraftModBlocks.PEANUT_STAGE_0.get().defaultBlockState();
		stage1 = BreadcraftModBlocks.PEANUT_STAGE_1.get().defaultBlockState();
		stage2 = BreadcraftModBlocks.PEANUT_STAGE_2.get().defaultBlockState();
		stage3 = BreadcraftModBlocks.PEANUT_STAGE_3.get().defaultBlockState();
		stage4 = BreadcraftModBlocks.PEANUT_STAGE_4.get().defaultBlockState();
		stage5 = BreadcraftModBlocks.PEANUT_STAGE_5.get().defaultBlockState();
		stage6 = BreadcraftModBlocks.PEANUT_STAGE_6.get().defaultBlockState();
