...
public class WildGreensUpdateTickProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z) {
		...
		logicLightGrowthCondition = WildGreensLightGrowthConditionProcedure.execute(world, x, y, z);
		numberGrowthCondition = WildGreensGrowthScoreConditionProcedure.execute(world, x, y, z);
		blockSoulSand = Blocks.SOUL_SAND.defaultBlockState();
		blockFarmland = Blocks.FARMLAND.defaultBlockState();
		blockStage0 = BreadcraftModBlocks.WILD_GREENS_STAGE_0.get().defaultBlockState();
		blockStage1 = BreadcraftModBlocks.WILD_GREENS_STAGE_1.get().defaultBlockState();
		blockStage2 = BreadcraftModBlocks.WILD_GREENS_STAGE_2.get().defaultBlockState();
		blockStage3 = BreadcraftModBlocks.WILD_GREENS_STAGE_3.get().defaultBlockState();
		blockStage4 = BreadcraftModBlocks.WILD_GREENS_STAGE_4.get().defaultBlockState();
		blockStage5 = BreadcraftModBlocks.WILD_GREENS_STAGE_5.get().defaultBlockState();
		blockStage6 = BreadcraftModBlocks.WILD_GREENS_STAGE_6.get().defaultBlockState();
		blockStage7 = BreadcraftModBlocks.WILD_GREENS_STAGE_7.get().defaultBlockState();
		...
		if (canDrop == true) {
			if (logicDropType == true) {
				WildGreensStage0ExplodedProcedure.execute(world, x, y, z);
			} else {
				WildGreensStage7ExplodedProcedure.execute(world, x, y, z);
			}
		}
	}
}
