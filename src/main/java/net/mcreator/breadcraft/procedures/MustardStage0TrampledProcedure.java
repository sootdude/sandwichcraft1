...
public class MustardStage0TrampledProcedure {
	@SubscribeEvent
	...
	private static void execute(@Nullable Event event, LevelAccessor world, double x, double y, double z) {
		...
		stage0 = BreadcraftModBlocks.MUSTARD_STAGE_0.get().defaultBlockState();
		stage1 = BreadcraftModBlocks.MUSTARD_STAGE_1.get().defaultBlockState();
		stage2 = BreadcraftModBlocks.MUSTARD_STAGE_2.get().defaultBlockState();
		stage3 = BreadcraftModBlocks.MUSTARD_STAGE_3.get().defaultBlockState();
		stage4 = BreadcraftModBlocks.MUSTARD_STAGE_4.get().defaultBlockState();
		stage5 = BreadcraftModBlocks.MUSTARD_STAGE_5.get().defaultBlockState();
		stage6 = BreadcraftModBlocks.MUSTARD_STAGE_6.get().defaultBlockState();
