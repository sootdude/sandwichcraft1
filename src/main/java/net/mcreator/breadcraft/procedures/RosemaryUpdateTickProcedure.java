...
public class RosemaryUpdateTickProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z) {
		...
		logicLightGrowthCondition = RosemaryLightGrowthConditionProcedure.execute(world, x, y, z);
		numberGrowthCondition = RosemaryGrowthScoreConditionProcedure.execute(world, x, y, z);
		blockSoulSand = Blocks.SOUL_SAND.defaultBlockState();
		blockFarmland = Blocks.FARMLAND.defaultBlockState();
		blockStage0 = BreadcraftModBlocks.ROSEMARY_STAGE_0.get().defaultBlockState();
		blockStage1 = BreadcraftModBlocks.ROSEMARY_STAGE_1.get().defaultBlockState();
		blockStage2 = BreadcraftModBlocks.ROSEMARY_STAGE_2.get().defaultBlockState();
		blockStage3 = BreadcraftModBlocks.ROSEMARY_STAGE_3.get().defaultBlockState();
		blockStage4 = BreadcraftModBlocks.ROSEMARY_STAGE_4.get().defaultBlockState();
		...
		if (canDrop == true) {
			if (logicDropType == true) {
				RosemaryStage0ExplodedProcedure.execute(world, x, y, z);
			} else {
				RosemaryStage7ExplodedProcedure.execute(world, x, y, z);
			}
		}
	}
}
