...
public class RosemaryGrassDropsProcedure {
	@SubscribeEvent
	...
	private static void execute(@Nullable Event event, LevelAccessor world, double x, double y, double z, Entity entity) {
		...
		if ((double) SootsandwichcraftConfigConfiguration.ROSEMARY_SEED_DROP_RATE.get() == 0) {
			if (world instanceof Level _level)
				_level.updateNeighborsAt(new BlockPos(x, y, z), _level.getBlockState(new BlockPos(x, y, z)).getBlock());
		}
		if ((double) SootsandwichcraftConfigConfiguration.ROSEMARY_SEED_DROP_RATE.get() > 0 && (double) SootsandwichcraftConfigConfiguration.ROSEMARY_SEED_DROP_RATE.get() < 2) {
		...
		if ((double) SootsandwichcraftConfigConfiguration.ROSEMARY_SEED_DROP_RATE.get() >= 2 && (double) SootsandwichcraftConfigConfiguration.ROSEMARY_SEED_DROP_RATE.get() < 3) {
			if ((world.getBlockState(new BlockPos(x, y, z))).getBlock() == blockTallGrass.getBlock() || (world.getBlockState(new BlockPos(x, y, z))).getBlock() == blockDoubleTallGrass.getBlock()
					|| (world.getBlockState(new BlockPos(x, y, z))).getBlock() == blockFern.getBlock() || (world.getBlockState(new BlockPos(x, y, z))).getBlock() == blockDoubleFern.getBlock()) {
				if (!world.isClientSide()) {
					randomNumber = Math.random();
		...
		if ((double) SootsandwichcraftConfigConfiguration.ROSEMARY_SEED_DROP_RATE.get() >= 3) {
			if ((world.getBlockState(new BlockPos(x, y, z))).getBlock() == blockTallGrass.getBlock() || (world.getBlockState(new BlockPos(x, y, z))).getBlock() == blockDoubleTallGrass.getBlock()
					|| (world.getBlockState(new BlockPos(x, y, z))).getBlock() == blockFern.getBlock() || (world.getBlockState(new BlockPos(x, y, z))).getBlock() == blockDoubleFern.getBlock()) {
				if (!world.isClientSide()) {
					randomNumber = Math.random();
