...
public class TomatoGrassDropsProcedure {
	@SubscribeEvent
	...
	private static void execute(@Nullable Event event, LevelAccessor world, double x, double y, double z, Entity entity) {
		...
		itemSeeds = new ItemStack(BreadcraftModItems.TOMATO_SEEDS.get());
		...
		if ((double) SootsandwichcraftConfigConfiguration.TOMATO_SEED_DROP_RATE.get() == 0) {
			if (world instanceof Level _level)
				_level.updateNeighborsAt(new BlockPos(x, y, z), _level.getBlockState(new BlockPos(x, y, z)).getBlock());
		}
		if ((double) SootsandwichcraftConfigConfiguration.TOMATO_SEED_DROP_RATE.get() > 0 && (double) SootsandwichcraftConfigConfiguration.TOMATO_SEED_DROP_RATE.get() < 2) {
		...
		if ((double) SootsandwichcraftConfigConfiguration.TOMATO_SEED_DROP_RATE.get() >= 2 && (double) SootsandwichcraftConfigConfiguration.TOMATO_SEED_DROP_RATE.get() < 3) {
			if ((world.getBlockState(new BlockPos(x, y, z))).getBlock() == blockTallGrass.getBlock() || (world.getBlockState(new BlockPos(x, y, z))).getBlock() == blockDoubleTallGrass.getBlock()
					|| (world.getBlockState(new BlockPos(x, y, z))).getBlock() == blockFern.getBlock() || (world.getBlockState(new BlockPos(x, y, z))).getBlock() == blockDoubleFern.getBlock()) {
				if (!world.isClientSide()) {
					randomNumber = Math.random();
					...
					if ((EnchantmentHelper.getItemEnchantmentLevel(Enchantments.BLOCK_FORTUNE, (entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY)) != 0) == true) {
						if (EnchantmentHelper.getItemEnchantmentLevel(Enchantments.BLOCK_FORTUNE, (entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY)) == 1) {
							if (randomNumber >= 0 && randomNumber <= 0.061) {
								...
								for (int index12 = 0; index12 < (int) (2); index12++) {
									if (world instanceof Level _level && !_level.isClientSide()) {
										ItemEntity entityToSpawn = new ItemEntity(_level, (x + 0.5), (y + 0.5), (z + 0.5), itemSeeds);
										entityToSpawn.setPickUpDelay(10);
										_level.addFreshEntity(entityToSpawn);
							...
							if (randomNumber >= 0 && randomNumber <= 0.017) {
								...
								for (int index21 = 0; index21 < (int) (5); index21++) {
									if (world instanceof Level _level && !_level.isClientSide()) {
										ItemEntity entityToSpawn = new ItemEntity(_level, (x + 0.5), (y + 0.5), (z + 0.5), itemSeeds);
										entityToSpawn.setPickUpDelay(10);
										_level.addFreshEntity(entityToSpawn);
		...
		if ((double) SootsandwichcraftConfigConfiguration.TOMATO_SEED_DROP_RATE.get() >= 3) {
			if ((world.getBlockState(new BlockPos(x, y, z))).getBlock() == blockTallGrass.getBlock() || (world.getBlockState(new BlockPos(x, y, z))).getBlock() == blockDoubleTallGrass.getBlock()
					|| (world.getBlockState(new BlockPos(x, y, z))).getBlock() == blockFern.getBlock() || (world.getBlockState(new BlockPos(x, y, z))).getBlock() == blockDoubleFern.getBlock()) {
				if (!world.isClientSide()) {
					randomNumber = Math.random();
					...
					if ((EnchantmentHelper.getItemEnchantmentLevel(Enchantments.BLOCK_FORTUNE, (entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY)) != 0) == true) {
						if (EnchantmentHelper.getItemEnchantmentLevel(Enchantments.BLOCK_FORTUNE, (entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY)) == 1) {
							if (randomNumber >= 0 && randomNumber <= 0.041) {
								...
								for (int index24 = 0; index24 < (int) (2); index24++) {
									if (world instanceof Level _level && !_level.isClientSide()) {
										ItemEntity entityToSpawn = new ItemEntity(_level, (x + 0.5), (y + 0.5), (z + 0.5), itemSeeds);
										entityToSpawn.setPickUpDelay(10);
										_level.addFreshEntity(entityToSpawn);
								...
								for (int index25 = 0; index25 < (int) (3); index25++) {
									if (world instanceof Level _level && !_level.isClientSide()) {
										ItemEntity entityToSpawn = new ItemEntity(_level, (x + 0.5), (y + 0.5), (z + 0.5), itemSeeds);
										entityToSpawn.setPickUpDelay(10);
										_level.addFreshEntity(entityToSpawn);
							...
							if (randomNumber >= 0 && randomNumber <= 0.025) {
								...
								for (int index26 = 0; index26 < (int) (2); index26++) {
									if (world instanceof Level _level && !_level.isClientSide()) {
										ItemEntity entityToSpawn = new ItemEntity(_level, (x + 0.5), (y + 0.5), (z + 0.5), itemSeeds);
										entityToSpawn.setPickUpDelay(10);
										_level.addFreshEntity(entityToSpawn);
								...
								for (int index27 = 0; index27 < (int) (3); index27++) {
									if (world instanceof Level _level && !_level.isClientSide()) {
										ItemEntity entityToSpawn = new ItemEntity(_level, (x + 0.5), (y + 0.5), (z + 0.5), itemSeeds);
										entityToSpawn.setPickUpDelay(10);
										_level.addFreshEntity(entityToSpawn);
								...
								for (int index29 = 0; index29 < (int) (5); index29++) {
									if (world instanceof Level _level && !_level.isClientSide()) {
										ItemEntity entityToSpawn = new ItemEntity(_level, (x + 0.5), (y + 0.5), (z + 0.5), itemSeeds);
										entityToSpawn.setPickUpDelay(10);
										_level.addFreshEntity(entityToSpawn);
							...
							if (randomNumber >= 0 && randomNumber <= 0.017) {
								...
								for (int index31 = 0; index31 < (int) (3); index31++) {
									if (world instanceof Level _level && !_level.isClientSide()) {
										ItemEntity entityToSpawn = new ItemEntity(_level, (x + 0.5), (y + 0.5), (z + 0.5), itemSeeds);
										entityToSpawn.setPickUpDelay(10);
										_level.addFreshEntity(entityToSpawn);
								...
								for (int index33 = 0; index33 < (int) (5); index33++) {
									if (world instanceof Level _level && !_level.isClientSide()) {
										ItemEntity entityToSpawn = new ItemEntity(_level, (x + 0.5), (y + 0.5), (z + 0.5), itemSeeds);
										entityToSpawn.setPickUpDelay(10);
										_level.addFreshEntity(entityToSpawn);
								...
								for (int index34 = 0; index34 < (int) (6); index34++) {
									if (world instanceof Level _level && !_level.isClientSide()) {
										ItemEntity entityToSpawn = new ItemEntity(_level, (x + 0.5), (y + 0.5), (z + 0.5), itemSeeds);
										entityToSpawn.setPickUpDelay(10);
										_level.addFreshEntity(entityToSpawn);
