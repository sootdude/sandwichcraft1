...
public class SaltPotGUISlotMessage {
	...
	public SaltPotGUISlotMessage(FriendlyByteBuf buffer) {
	...
	public static void buffer(SaltPotGUISlotMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(SaltPotGUISlotMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
