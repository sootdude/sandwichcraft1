...
public class CountryGrilledCheeseItem extends Item {
	public CountryGrilledCheeseItem() {
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(Component.literal("\u00A72Grilled cheese made with rustic white bread."));
	}
}
