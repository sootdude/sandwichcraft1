...
public class SourdoughGrilledCheeseItem extends Item {
	public SourdoughGrilledCheeseItem() {
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(new TextComponent("\u00A72Grilled cheese made with sourdough bread."));
	}
}
