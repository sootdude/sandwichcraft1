...
public class SaltPotBlockEntity extends RandomizableContainerBlockEntity implements WorldlyContainer {
	private NonNullList<ItemStack> stacks = NonNullList.<ItemStack>withSize(6, ItemStack.EMPTY);
	private final LazyOptional<? extends IItemHandler>[] handlers = SidedInvWrapper.create(this, Direction.values());

	public SaltPotBlockEntity(BlockPos position, BlockState state) {
		super(BreadcraftModBlockEntities.SALT_POT.get(), position, state);
	}
	...
	public Component getDefaultName() {
		return new TextComponent("salt_pot");
	}
	...
	public AbstractContainerMenu createMenu(int id, Inventory inventory) {
		return new SaltPotGUIMenu(id, inventory, new FriendlyByteBuf(Unpooled.buffer()).writeBlockPos(this.worldPosition));
	}
