...
public class SaltPotFullBlockEntity extends RandomizableContainerBlockEntity implements WorldlyContainer {
	private NonNullList<ItemStack> stacks = NonNullList.<ItemStack>withSize(6, ItemStack.EMPTY);
	private final LazyOptional<? extends IItemHandler>[] handlers = SidedInvWrapper.create(this, Direction.values());

	public SaltPotFullBlockEntity(BlockPos position, BlockState state) {
		super(BreadcraftModBlockEntities.SALT_POT_FULL.get(), position, state);
	}
	...
	public Component getDefaultName() {
		return new TextComponent("salt_pot_full");
	}
